...
The <a href="../community/roadmap.md">Roadmap</a> summarizes plans for upcoming additions to TensorFlow.
...
can be found at <a href="../community/lists.md">TensorFlow Mailing Lists</a>.

### User Groups

To meet with like-minded people local to you, check out the many
<a href="../community/groups.md">TensorFlow user groups</a> around the world.
