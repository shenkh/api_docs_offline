...
5.  Test the op. We usually do this in Python for convenience, but you can also
    ...
    Python <a href="../api_docs/python/tf/test/compute_gradient_error.md">gradient checker</a>.
    See
...
*   Must have installed the
    <a href="../install/index.md">TensorFlow binary</a>, or must have
    <a href="../install/install_sources.md">downloaded TensorFlow source</a>,
...
<a href="../api_docs/python/tf/DType.md">tensor types</a> used for inputs and outputs.)
...
* `{<type1>, <type2>}`: The value is of type `type`, and must be one of
  ...
  <a href="../api_docs/python/tf/DType.md">tensor types</a>.  You don't specify
...
use <a href="../api_docs/python/tf/DType.md">the <code>DT_*</code> names for the types</a>.
...
>     out_type: An optional <a href="../api_docs/python/tf/DType.md"><code>tf.DType</code></a> from: `tf.float32, tf.int32`.
>       Defaults to <a href="../api_docs/python/tf/float32.md"><code>tf.float32</code></a>.
>     name: A name for the operation (optional).
>
>   Returns:
...
* `<type>`, where `<type>` is a supported input type (e.g. `float`, `int32`,
  ...
  See
  <a href="../api_docs/python/tf/DType.md">the list of supported Tensor types</a>.
...
* For a sequence of tensors with the same type: `<number> * <type>`, where
  ...
  either be
  <a href="../api_docs/python/tf/DType.md">a specific type like <code>int32</code> or <code>float</code></a>,
...
<a href="../guide/version_compat.md#compatibility_of_graphs_and_checkpoints">described here</a>.
...
<a href="../guide/version_compat.md#compatibility_of_graphs_and_checkpoints"><code>GraphDef</code> version semantics</a>.
...
existing ops (see
<a href="../api_guides/python/train.md#gradient_computation">Gradient Computation</a>).
