...
and sessions. See <a href="../guide/low_level_intro.md">this document</a> for an introduction to
these topics. Some familiarity with <a href="../deploy/distributed.md">distributed TensorFlow</a>
...
distributed master as a <a href="../api_docs/python/tf/GraphDef.md"><code>tf.GraphDef</code></a>
...
communication (see [<a href="../api_docs/python/tf/contrib/nccl.md"><code>tf.contrib.nccl</code></a>](
...
<a href="../performance/quantization.md">quantization</a>, which enables
...
Sigmoid activation functions and their corresponding gradients. The <a href="../performance/xla/index.md">XLA Compiler</a> has an
