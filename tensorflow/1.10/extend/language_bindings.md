...
Feature                                        | Python                                                      | C
:--------------------------------------------- | :---------------------------------------------------------- | :--
Run a predefined Graph                         | <a href="../api_docs/python/tf/import_graph_def.md"><code>tf.import_graph_def</code></a>, <a href="../api_docs/python/tf/Session.md"><code>tf.Session</code></a>                         | `TF_GraphImportGraphDef`, `TF_NewSession`
Graph construction with generated op functions | Yes                                                         | Yes (The C API supports client languages that do this)
Gradients                                      | <a href="../api_docs/python/tf/gradients.md"><code>tf.gradients</code></a>                                              |
Functions                                      | `tf.python.framework.function.Defun`                        |
Control Flow                                   | <a href="../api_docs/python/tf/cond.md"><code>tf.cond</code></a>, <a href="../api_docs/python/tf/while_loop.md"><code>tf.while_loop</code></a>                                  |
Neural Network library                         | <a href="../api_docs/python/tf/train.md"><code>tf.train</code></a>, <a href="../api_docs/python/tf/nn.md"><code>tf.nn</code></a>, <a href="../api_docs/python/tf/contrib/layers.md"><code>tf.contrib.layers</code></a>, <a href="../api_docs/python/tf/contrib/slim.md"><code>tf.contrib.slim</code></a> |
...
-   A list of inputs and outputs. The types for these may be polymorphic by
    ...
    <a href="../extend/adding_an_op.md">Adding an     op</a>.
