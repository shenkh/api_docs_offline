...
<a href="../guide/saved_model.md">Saving and Restoring</a> guide.


## Sample code

This document relies on the same
[Iris classification example](https://github.com/tensorflow/models/blob/master/samples/core/get_started/premade_estimator.py) detailed in <a href="../guide/premade_estimators.md">Getting Started with TensorFlow</a>.
...
1.  Create a <a href="../api_docs/python/tf/estimator/RunConfig.md"><code>RunConfig</code></a> object that defines the
    desired schedule.
...
1.  The Estimator builds the model's
    ...
    <a href="../guide/custom_estimators.md">Creating Custom Estimators.</a>)
...
See the <a href="../guide/saved_model.md">Saving and Restoring</a> guide for details about:
