...
In <a href="../guide/premade_estimators.md">Premade Estimators</a>, we used the premade
Estimator, <a href="../api_docs/python/tf/estimator/DNNClassifier.md"><code>DNNClassifier</code></a> to train a model to
...
<a href="../api_docs/python/tf/feature_column/numeric_column.md"><code>tf.feature_column.numeric_column</code></a>). Although numerical feature columns model
...
is, of course, numbers (for example, <a href="../api_docs/python/tf/float32.md"><code>tf.float32</code></a>). After all, every neuron in
...
<a href="../api_docs/python/tf/feature_column.md"><code>tf.feature_column</code></a> module. This document explains nine of the functions in
...
The Iris classifier calls the <a href="../api_docs/python/tf/feature_column/numeric_column.md"><code>tf.feature_column.numeric_column</code></a> function for
all input features:
...
a numerical value with the default data type (<a href="../api_docs/python/tf/float32.md"><code>tf.float32</code></a>) as input to your
model:
...
create a <a href="../api_docs/python/tf/feature_column/bucketized_column.md">bucketized column</a>. For
...
Call <a href="../api_docs/python/tf/feature_column/categorical_column_with_identity.md"><code>tf.feature_column.categorical_column_with_identity</code></a> to implement a
...
* <a href="../api_docs/python/tf/feature_column/categorical_column_with_vocabulary_list.md"><code>tf.feature_column.categorical_column_with_vocabulary_list</code></a>
* <a href="../api_docs/python/tf/feature_column/categorical_column_with_vocabulary_file.md"><code>tf.feature_column.categorical_column_with_vocabulary_file</code></a>
...
<a href="../api_docs/python/tf/feature_column/categorical_column_with_vocabulary_file.md"><code>tf.feature_column.categorical_column_with_vocabulary_file</code></a> instead, which lets
...
<a href="../api_docs/python/tf/feature_column/categorical_column_with_hash_bucket.md"><code>tf.feature_column.categorical_column_with_hash_bucket</code></a> function enables you
...
earlier, with the <a href="../api_docs/python/tf/feature_column/crossed_column.md"><code>tf.feature_column.crossed_column</code></a> function.
...
<a href="../api_docs/python/tf/feature_column/indicator_column.md"><code>tf.feature_column.indicator_column</code></a>:
...
Call <a href="../api_docs/python/tf/feature_column/embedding_column.md"><code>tf.feature_column.embedding_column</code></a> to create an `embedding_column` as
...
<a href="../guide/embedding.md">Embeddings</a> is a significant topic within machine
...
* <a href="../api_docs/python/tf/estimator/LinearClassifier.md"><code>LinearClassifier</code></a> and
  <a href="../api_docs/python/tf/estimator/LinearRegressor.md"><code>LinearRegressor</code></a>: Accept all types of
  feature column.
* <a href="../api_docs/python/tf/estimator/DNNClassifier.md"><code>DNNClassifier</code></a> and
  <a href="../api_docs/python/tf/estimator/DNNRegressor.md"><code>DNNRegressor</code></a>: Only accept dense columns. Other
  column types must be wrapped in either an `indicator_column` or
  `embedding_column`.
* <a href="../api_docs/python/tf/estimator/DNNLinearCombinedClassifier.md"><code>DNNLinearCombinedClassifier</code></a> and
  <a href="../api_docs/python/tf/estimator/DNNLinearCombinedRegressor.md"><code>DNNLinearCombinedRegressor</code></a>:
...
* The <a href="../guide/low_level_intro.md#feature_columns">Low Level Introduction</a> demonstrates how
