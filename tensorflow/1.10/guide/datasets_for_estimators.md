...
The <a href="../guide/premade_estimators.md">Premade Estimators</a> chapter describes
...
<a href="../guide/tensors.md#shapes">shapes</a> and
<a href="../guide/tensors.md#data_types">types</a> of the items in
...
dictionaries of <a href="../guide/tensors.md#rank">scalars</a>, all of type
...
The <a href="../api_docs/python/tf/data/Dataset.md#shuffle"><code>shuffle</code></a> method uses a fixed-size buffer to
...
The <a href="../api_docs/python/tf/data/Dataset.md#repeat"><code>repeat</code></a> method restarts the `Dataset` when
it reaches the end. To limit the number of epochs, set the `count` argument.

The <a href="../api_docs/python/tf/data/Dataset.md#batch"><code>batch</code></a> method collects a number of examples and
...
We start by building a <a href="../api_docs/python/tf/data/TextLineDataset.md"><code>TextLineDataset</code></a> object to
read the file one line at a time. Then, we call the
<a href="../api_docs/python/tf/data/Dataset.md#skip"><code>skip</code></a> method to skip over the first line of the file, which contains a header, not an example:
...
to a model. The most heavily-used method is <a href="../api_docs/python/tf/data/Dataset.md#map"><code>map</code></a>, which
...
The <a href="../api_docs/python/tf/data/Dataset.md#map"><code>map</code></a> method applies the `map_func` to
...
* <a href="../guide/custom_estimators.md">Creating Custom Estimators</a>, which demonstrates how to build your own
  custom `Estimator` model.
* The <a href="../guide/low_level_intro.md#datasets">Low Level Introduction</a>, which demonstrates
  how to experiment directly with `tf.data.Datasets` using TensorFlow's low
  level APIs.
* <a href="../guide/datasets.md">Importing Data</a> which goes into great detail about additional
