...
* All the documented [Python](../api_docs/python) functions and classes in the
  `tensorflow` module and its submodules, except for
    * functions and classes in <a href="../api_docs/python/tf/contrib.md"><code>tf.contrib</code></a>
...
*   **Experimental APIs**: The <a href="../api_docs/python/tf/contrib.md"><code>tf.contrib</code></a> module and its submodules in Python
...
*   **Other languages**: TensorFlow APIs in languages other than Python and C,
  ...
  - <a href="../api_guides/cc/guide.md">C++</a> (exposed through header files in
...
*   **Random numbers:** The specific random numbers computed by the
    <a href="../api_guides/python/constant_op.md#Random_Tensors">random ops</a> may change at any time.
...
1. If forward compatibility is desired,  set `strip_default_attrs` to `True`
   ...
   <a href="../api_docs/python/tf/saved_model/builder/SavedModelBuilder.md#add_meta_graph_and_variables"><code>add_meta_graph_and_variables</code></a>
   and <a href="../api_docs/python/tf/saved_model/builder/SavedModelBuilder.md#add_meta_graph"><code>add_meta_graph</code></a>
   methods of the `SavedModelBuilder` class, or
   <a href="../api_docs/python/tf/estimator/BaselineClassifier.md#export_savedmodel"><code>Estimator.export_savedmodel</code></a>
2. This strips off the default valued attributes at the time of
   ...
   <a href="../api_docs/python/tf/MetaGraphDef.md"><code>tf.MetaGraphDef</code></a> does not contain the new op-attribute when the default
   value is used.
