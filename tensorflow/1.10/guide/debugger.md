...
we ship it with the
<a href="../api_guides/python/tfdbg.md#Classes_for_debug_dump_data_and_directories"><code>debug_data</code></a>
module.

Note: You can also write your own custom filters. See
the <a href="../api_docs/python/tfdbg/DebugDumpDir.md#find">API documentation</a>
...
<a href="../api_docs/python/tf/estimator/BaselineClassifier.md#train"><code>train()</code></a>,
<a href="../api_docs/python/tf/estimator/BaselineClassifier.md#evaluate"><code>evaluate()</code></a> and
<a href="../api_docs/python/tf/estimator/BaselineClassifier.md#predict"><code>predict()</code></a>
...
<a href="../api_docs/python/tfdbg/DumpingDebugWrapperSession.md#__init__">this API doc</a>
for more details.
