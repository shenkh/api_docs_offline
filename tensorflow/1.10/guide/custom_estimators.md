...
demonstrates how to create a custom <a href="../api_docs/python/tf/estimator/Estimator.md">Estimator</a> that
mimics the behavior of the pre-made Estimator
<a href="../api_docs/python/tf/estimator/DNNClassifier.md"><code>DNNClassifier</code></a> in solving the Iris problem. See
the <a href="../guide/premade_estimators.md">Pre-Made Estimators chapter</a> for details
on the Iris problem.
...
<a href="../guide/premade_estimators.md">pre-made Estimator implementation</a>, from
...
As detailed in the <a href="../guide/premade_estimators.md">Premade Estimators</a> and
<a href="../guide/feature_columns.md">Feature Columns</a> chapters, you must define
...
<a href="../guide/premade_estimators.md">Premade Estimators</a>.
...
|:---------------------------------|:------------------|
|<a href="../api_docs/python/tf/estimator/BaselineClassifier.md#train"><code>train()</code></a> |<a href="../api_docs/python/tf/estimator/ModeKeys.md#TRAIN"><code>ModeKeys.TRAIN</code></a> |
|<a href="../api_docs/python/tf/estimator/BaselineClassifier.md#evaluate"><code>evaluate()</code></a>  |<a href="../api_docs/python/tf/estimator/ModeKeys.md#EVAL"><code>ModeKeys.EVAL</code></a>      |
|<a href="../api_docs/python/tf/estimator/BaselineClassifier.md#predict"><code>predict()</code></a>|<a href="../api_docs/python/tf/estimator/ModeKeys.md#PREDICT"><code>ModeKeys.PREDICT</code></a> |
...
<a href="../api_docs/python/tf/estimator/BaselineClassifier.md#predict"><code>predict</code></a> method will yield these
dictionaries.
...
The <a href="../api_docs/python/tf/estimator/EstimatorSpec.md"><code>EstimatorSpec</code></a> returned for evaluation
...
<a href="../api_docs/python/tf/train/AdadeltaOptimizer.md#minimize"><code>minimize</code></a> method on the loss we calculated
earlier.
...
The <a href="../api_docs/python/tf/estimator/EstimatorSpec.md"><code>EstimatorSpec</code></a> returned for training
...
<a href="../guide/premade_estimators.md">Premade Estimators</a> chapter. For
...
* This [TensorBoard video](https://youtu.be/eBbEDRsCmv4), which introduces
  TensorBoard.
* The <a href="../guide/low_level_intro.md">Low Level Introduction</a>, which demonstrates
