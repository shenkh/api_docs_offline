...
This document introduces <a href="../api_docs/python/tf/estimator.md">**Estimators**</a>--a high-level TensorFlow
...
*   Estimators are themselves built on <a href="../api_docs/python/tf/layers.md"><code>tf.layers</code></a>, which
...
<a href="../api_docs/python/tf/Graph.md"><code>Graph</code></a> and <a href="../api_docs/python/tf/Session.md"><code>Session</code></a> objects for you.  Furthermore,
pre-made Estimators let you experiment with different model architectures by
making only minimal code changes.  <a href="../api_docs/python/tf/estimator/DNNClassifier.md"><code>DNNClassifier</code></a>,
...
1.  **Write one or more dataset importing functions.** For example, you might
    ...
    *   a Tensor containing one or more labels
    ...
    (See <a href="../guide/datasets.md">Importing Data</a> for full details.)
...
<a href="../guide/custom_estimators.md">companion document</a>
