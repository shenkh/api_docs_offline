...
The <a href="../api_docs/python/tf/data.md"><code>tf.data</code></a> API enables you to build complex input pipelines from
...
table, and batching together sequences of different lengths. The <a href="../api_docs/python/tf/data.md"><code>tf.data</code></a> API
makes it easy to deal with large amounts of data, different data formats, and
complicated transformations.

The <a href="../api_docs/python/tf/data.md"><code>tf.data</code></a> API introduces two new abstractions to TensorFlow:

* A <a href="../api_docs/python/tf/data/Dataset.md"><code>tf.data.Dataset</code></a> represents a sequence of elements, in which
  ...
  ways to create a dataset:
    ...
    * Creating a **source** (e.g. `Dataset.from_tensor_slices()`) constructs a
    dataset from
    one or more <a href="../api_docs/python/tf/Tensor.md"><code>tf.Tensor</code></a> objects.

    * Applying a **transformation** (e.g. `Dataset.batch()`) constructs a dataset
    from one or more <a href="../api_docs/python/tf/data/Dataset.md"><code>tf.data.Dataset</code></a> objects.

* A <a href="../api_docs/python/tf/data/Iterator.md"><code>tf.data.Iterator</code></a> provides the main way to extract elements from a
...
chaining method calls on the <a href="../api_docs/python/tf/data/Dataset.md"><code>tf.data.Dataset</code></a> object. For example, you
...
`Dataset.batch()`. See the documentation for <a href="../api_docs/python/tf/data/Dataset.md"><code>tf.data.Dataset</code></a>
...
<a href="../api_docs/python/tf/data/Iterator.md"><code>tf.data.Iterator</code></a> provides two operations: `Iterator.initializer`,
which enables you to (re)initialize the iterator's state; and
`Iterator.get_next()`, which returns <a href="../api_docs/python/tf/Tensor.md"><code>tf.Tensor</code></a> objects that correspond to the
...
has a <a href="../api_docs/python/tf/DType.md"><code>tf.DType</code></a> representing the type of elements in the tensor, and a
...
create an `Iterator` to access elements from that dataset.  The <a href="../api_docs/python/tf/data.md"><code>tf.data</code></a> API
...
A **feedable** iterator can be used together with <a href="../api_docs/python/tf/placeholder.md"><code>tf.placeholder</code></a> to select
what `Iterator` to use in each call to <a href="../api_docs/python/tf/InteractiveSession.md#run"><code>tf.Session.run</code></a>, via the familiar
...
<a href="../api_docs/python/tf/data/Iterator.md#from_string_handle"><code>tf.data.Iterator.from_string_handle</code></a> to define a feedable iterator
...
The `Iterator.get_next()` method returns one or more <a href="../api_docs/python/tf/Tensor.md"><code>tf.Tensor</code></a> objects that
...
must use the returned <a href="../api_docs/python/tf/Tensor.md"><code>tf.Tensor</code></a> objects in a TensorFlow expression, and pass
...
the `Iterator.get_next()` operation will raise a <a href="../api_docs/python/tf/errors/OutOfRangeError.md"><code>tf.errors.OutOfRangeError</code></a>.
...
`Iterator.get_next()` will be one or more <a href="../api_docs/python/tf/Tensor.md"><code>tf.Tensor</code></a> objects in the same
nested structure:
...
The <a href="../api_docs/python/tf/contrib/data/make_saveable_from_iterator.md"><code>tf.contrib.data.make_saveable_from_iterator</code></a> function creates a
...
pipeline). A saveable object thus created can be added to <a href="../api_docs/python/tf/train/Saver.md"><code>tf.train.Saver</code></a>
variables list or the <a href="../api_docs/python/tf/GraphKeys.md#SAVEABLE_OBJECTS"><code>tf.GraphKeys.SAVEABLE_OBJECTS</code></a> collection for saving and
restoring in the same manner as a <a href="../api_docs/python/tf/Variable.md"><code>tf.Variable</code></a>. Refer to
<a href="../guide/saved_model.md">Saving and Restoring</a> for details on how to save and restore
variables.
...
<a href="../api_docs/python/tf/data/TextLineDataset.md"><code>tf.data.TextLineDataset</code></a> provides an easy way to extract lines from
...
`TFRecordDataset`, `TextLineDataset` accepts `filenames` as a <a href="../api_docs/python/tf/Tensor.md"><code>tf.Tensor</code></a>, so
...
The <a href="../api_docs/python/tf/contrib/data/CsvDataset.md"><code>tf.contrib.data.CsvDataset</code></a> class provides a way to extract records from
...
`CsvDataset` accepts `filenames` as a <a href="../api_docs/python/tf/Tensor.md"><code>tf.Tensor</code></a>, so you can parameterize it
...
<a href="../api_docs/python/tf/python_io/TFRecordWriter.md"><code>tf.python_io.TFRecordWriter</code></a>). Each <a href="../api_docs/python/tf/train/Example.md"><code>tf.train.Example</code></a> record contains one or
...
training loop that catches the <a href="../api_docs/python/tf/errors/OutOfRangeError.md"><code>tf.errors.OutOfRangeError</code></a> at the end of a
...
using a similar algorithm to <a href="../api_docs/python/tf/RandomShuffleQueue.md"><code>tf.RandomShuffleQueue</code></a>: it maintains a fixed-size
...
The <a href="../api_docs/python/tf/train/MonitoredTrainingSession.md"><code>tf.train.MonitoredTrainingSession</code></a> API simplifies many aspects of running
TensorFlow in a distributed setting. `MonitoredTrainingSession` uses the
<a href="../api_docs/python/tf/errors/OutOfRangeError.md"><code>tf.errors.OutOfRangeError</code></a> to signal that training has completed, so to use it
with the <a href="../api_docs/python/tf/data.md"><code>tf.data</code></a> API, we recommend using
...
To use a `Dataset` in the `input_fn` of a <a href="../api_docs/python/tf/estimator/Estimator.md"><code>tf.estimator.Estimator</code></a>, we also
