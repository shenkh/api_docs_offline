...
<a href="../../api_docs/cc/class/tensorflow/scope.md"><code>tensorflow::Scope</code></a> is the main data structure that holds the current state
...
<a href="../../api_docs/cc/class/tensorflow/status.md"><code>tensorflow::Status</code></a> object which will be used to indicate errors encountered
...
Please refer to <a href="../../api_docs/cc/class/tensorflow/scope.md"><code>tensorflow::Scope</code></a> for the complete list of member functions
...
<a href="../../api_docs/cc/namespace/tensorflow/ops.md#const"><code>tensorflow::ops::Const</code></a> function from various kinds of C++ values. For
example:
...
<a href="../../api_docs/cc/class/tensorflow/client-session.md"><code>tensorflow::ClientSession</code></a> class that will execute ops created by the
...
Please see the <a href="../../api_docs/cc/class/tensorflow/tensor.md"><code>tensorflow::Tensor</code></a> documentation for more information on how
