...
<a href="../../guide/datasets.md"><code>tf.data</code> API</a>.

There are four methods of getting data into a TensorFlow program:

*   <a href="../../api_docs/python/tf/data.md"><code>tf.data</code></a> API: Easily construct a complex input pipeline. (preferred method)
...
<h2 id="_a_href_api_docs_python_tf_data_md_code_tf_data_code_a_API"><a href="../../api_docs/python/tf/data.md"><code>tf.data</code></a> API</h2>

See the <a href="../../guide/datasets.md">Importing Data</a> for an in-depth explanation of <a href="../../api_docs/python/tf/data/Dataset.md"><code>tf.data.Dataset</code></a>.
The <a href="../../api_docs/python/tf/data.md"><code>tf.data</code></a> API enables you to extract and preprocess data
...
<a href="../../api_docs/python/tf/placeholder.md"><code>tf.placeholder</code></a> node. A
...
<h2 id="_QueueRunner_">`QueueRunner`</h2>

Warning: This section discusses implementing input pipelines using the
queue-based APIs which can be cleanly replaced by the <a href="../../guide/datasets.md"><code>tf.data</code>
API</a>.
...
<a href="../../api_docs/python/tf/train/match_filenames_once.md"><code>tf.train.match_filenames_once</code></a> function.

Pass the list of filenames to the <a href="../../api_docs/python/tf/train/string_input_producer.md"><code>tf.train.string_input_producer</code></a> function.
...
<a href="../../api_docs/python/tf/TextLineReader.md"><code>tf.TextLineReader</code></a> with the
<a href="../../api_docs/python/tf/decode_csv.md"><code>tf.decode_csv</code></a> operation. For example:
...
You must call <a href="../../api_docs/python/tf/train/start_queue_runners.md"><code>tf.train.start_queue_runners</code></a> to populate the queue before
...
with the <a href="../../api_docs/python/tf/decode_raw.md"><code>tf.decode_raw</code></a> operation.
...
and described in
<a href="../../tutorials/images/deep_cnn.md#prepare-the-data">this tutorial</a>.
...
<a href="../../api_guides/python/python_io.md#tfrecords_format_details">TFRecords file</a>
containing
[<a href="../../api_docs/python/tf/train/Example.md"><code>tf.train.Example</code></a> protocol buffers](https://www.tensorflow.org/code/tensorflow/core/example/example.proto)
(which contain
...
The recommended way to read a TFRecord file is with a <a href="../../api_docs/python/tf/data/TFRecordDataset.md"><code>tf.data.TFRecordDataset</code></a>, [as in this example](https://www.tensorflow.org/code/tensorflow/examples/how_tos/reading_data/fully_connected_reader.py):
...
<a href="../../guide/summaries_and_tensorboard.md">view your summaries as training progresses using TensorBoard</a>.

### Creating threads to prefetch using `QueueRunner` objects

The short version: many of the <a href="../../api_docs/python/tf/train.md"><code>tf.train</code></a> functions listed above add
<a href="../../api_docs/python/tf/train/QueueRunner.md"><code>tf.train.QueueRunner</code></a> objects to your
...
<a href="../../api_docs/python/tf/train/Coordinator.md"><code>tf.train.Coordinator</code></a> to cleanly
...
The helpers in <a href="../../api_docs/python/tf/train.md"><code>tf.train</code></a> that create these queues and enqueuing operations add
a <a href="../../api_docs/python/tf/train/QueueRunner.md"><code>tf.train.QueueRunner</code></a> to the
graph using the
...
<a href="../../api_docs/python/tf/errors/OutOfRangeError.md"><code>tf.errors.OutOfRangeError</code></a>. This
...
<a href="../../api_docs/python/tf/train/Coordinator.md"><code>tf.train.Coordinator</code></a>. This is responsible
...
<a href="../../api_guides/python/threading_and_queues.md">see here</a>.
...
<a href="../../api_docs/python/tf/RandomShuffleQueue.md"><code>tf.RandomShuffleQueue</code></a>, say
...
<a href="../../api_docs/python/tf/train/Coordinator.md#join"><code>tf.train.Coordinator.join</code></a>
...
<a href="../../api_docs/python/tf/parse_example.md"><code>tf.parse_example</code></a> **after**
batching (instead of using <a href="../../api_docs/python/tf/parse_single_example.md"><code>tf.parse_single_example</code></a> before batching).

<h2 id="Preloaded_data">Preloaded data</h2>
...
<a href="../../api_docs/python/tf/train/batch.md"><code>tf.train.batch</code></a> function.  To use
...
<h2 id="Multiple_input_pipelines">Multiple input pipelines</h2>
...
This is what is done <a href="../../api_docs/python/tf/estimator.md">estimators</a> and manually in
<a href="../../tutorials/images/deep_cnn.md#save-and-restore-checkpoints">the example CIFAR-10 model</a>.
...
their trained variables or layers. See <a href="../../guide/variables.md">the shared variables tutorial</a>.

To support the single-graph approach
<a href="../../guide/datasets.md"><code>tf.data</code></a> also supplies
<a href="../../guide/datasets.md#creating_an_iterator">advanced iterator types</a> that
...
operations (like <a href="../../api_docs/python/tf/layers/batch_normalization.md"><code>tf.layers.batch_normalization</code></a>, and <a href="../../api_docs/python/tf/layers/dropout.md"><code>tf.layers.dropout</code></a>)
