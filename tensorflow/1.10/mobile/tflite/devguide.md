...
to a <a href="../../api_docs/python/tf/GraphDef.md"><code>tf.GraphDef</code></a> file. This is required because some formats do not store the
...
Tensorflow model and you should now have a .pb or .pbtxt <a href="../../api_docs/python/tf/GraphDef.md"><code>tf.GraphDef</code></a> file.
...
* <a href="../../api_docs/python/tf/GraphDef.md"><code>tf.GraphDef</code></a> (.pb) —A protobuf that represents the TensorFlow training or
...
<a href="../../performance/quantization.md">quantized model</a>. Setting the `input_array`,
...
See the <a href="../../mobile/tflite/demo_android.md">Android Demo App</a> guide for details.

The <a href="../../mobile/android_build.md">Building TensorFlow on Android</a> guide has instructions for installing TensorFlow on
...
guide and <a href="../../mobile/tflite/demo_ios.md">iOS Demo App</a> guide.
