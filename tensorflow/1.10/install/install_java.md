...
meets the
<a href="../install/install_linux.md#determine_which_tensorflow_to_install">requirements for GPU</a>.
...
Take the following steps to install TensorFlow for Java on Linux or macOS:
  ...
  2. Decide whether you will run TensorFlow for Java on CPU(s) only or with
     ...
     * <a href="../install/install_linux.md#determine_which_tensorflow_to_install">Installing TensorFlow on Linux</a>
     * <a href="../install/install_mac.md#determine_which_tensorflow_to_install">Installing TensorFlow on macOS</a>
