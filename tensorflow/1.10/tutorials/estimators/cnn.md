...
The TensorFlow <a href="../../api_docs/python/tf/layers.md"><code>layers</code> module</a> provides a high-level API that makes
...
The <a href="../../api_docs/python/tf/layers.md"><code>tf.layers</code></a> module contains methods to create each of the three layer types
above:
...
<a href="../../api_docs/python/tf/estimator/ModeKeys.md">model mode</a> (`TRAIN`, `EVAL`, `PREDICT`) as arguments;
...
dive deeper into the <a href="../../api_docs/python/tf/layers.md"><code>tf.layers</code></a> code used to create each layer, as well as how
to calculate loss, configure the training op, and generate predictions. If
you're already experienced with CNNs and <a href="../../guide/custom_estimators.md">TensorFlow <code>Estimator</code>s</a>,
...
we'll use <a href="../../api_docs/python/tf/nn/relu.md"><code>tf.nn.relu</code></a> to add ReLU activation.
...
element using the <a href="../../api_docs/python/tf/argmax.md"><code>tf.argmax</code></a>
function:
...
using <a href="../../api_docs/python/tf/nn/softmax.md"><code>tf.nn.softmax</code></a>:
...
<a href="../../api_docs/python/tf/losses/sparse_softmax_cross_entropy.md"><code>tf.losses.sparse_softmax_cross_entropy</code></a>, calculates the softmax crossentropy
...
> functions, see <a href="../../guide/custom_estimators.md#defining-the-training-op-for-the-model">"Defining the training op for the model"</a>
> in the <a href="../../guide/custom_estimators.md">"Creating Estimations in tf.estimator"</a> tutorial.
...
> tutorial <a href="../../guide/custom_estimators.md">"Creating Estimators in tf.estimator."</a>

### Set Up a Logging Hook {#set_up_a_logging_hook}

Since CNNs can take a while to train, let's set up some logging so we can track
progress during training. We can use TensorFlow's <a href="../../api_docs/python/tf/train/SessionRunHook.md"><code>tf.train.SessionRunHook</code></a> to create a
...
> <a href="../../guide/graph_viz.md">TensorBoard</a>) or to enable the
> <a href="../../guide/debugger.md">TensorFlow Debugger (tfdbg)</a>.
...
*   <a href="../../guide/custom_estimators.md">Creating Estimators in tf.estimator</a>
    provides an introduction to the TensorFlow Estimator API. It walks through
    configuring an Estimator, writing a model function, calculating loss, and
    defining a training op.
*   <a href="../../tutorials/images/deep_cnn.md">Advanced Convolutional Neural Networks</a> walks through how to build a MNIST CNN classification model
