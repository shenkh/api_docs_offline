...
If you've followed
<a href="../../install/install_sources.md">the instructions to download the source installation of TensorFlow</a>
...
```C++
  ...
  return Status::OK();
```
Then we create a <a href="../../api_docs/python/tf/Session.md"><code>tf.Session</code></a>
...
to the TensorFlow <a href="../../tutorials/images/deep_cnn.md">deep convolutional networks tutorial</a>,
