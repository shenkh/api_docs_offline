...
See the guide: [Variables > Variables](../../../api_guides/python/state_ops.md#Variables)
...
Variable objects or simple functions thereof as predicates in a <a href="../tf/cond.md"><code>tf.cond</code></a> is
...
* Replace <a href="../tf/Variable.md"><code>tf.Variable</code></a> with <a href="../tf/contrib/eager/Variable.md"><code>tf.contrib.eager.Variable</code></a>;
* Call `tf.get_variable_scope().set_use_resource(True)` inside a
  <a href="../tf/variable_scope.md"><code>tf.variable_scope</code></a> before the `tf.get_variable()` call.



#### Eager Compatibility
<a href="../tf/Variable.md"><code>tf.Variable</code></a> is not compatible with eager execution.  Use
<a href="../tf/contrib/eager/Variable.md"><code>tf.contrib.eager.Variable</code></a> instead which is compatible with both eager
