...
Defined in [`tensorflow/keras/__init__.py`](https://www.tensorflow.org/code/tensorflow/keras/__init__.py).
...
[`initializers`](../tf/keras/initializers.md) module: Keras initializer classes (soon to be replaced with core TF initializers).
