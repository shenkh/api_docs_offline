...
See the guides: [Dataset Input Pipeline > Reader classes](../../../../api_guides/python/input_dataset.md#Reader_classes), [Reading data > `QueueRunner`](../../../../api_guides/python/reading_data.md#_QueueRunner_)
...
* <b>`filenames`</b>: A <a href="../../tf/string.md"><code>tf.string</code></a> tensor or <a href="../../tf/data/Dataset.md"><code>tf.data.Dataset</code></a> containing one or
    more filenames.
...
* <b>`num_parallel_reads`</b>: (Optional.) A <a href="../../tf/int64.md"><code>tf.int64</code></a> scalar representing the
