...
<meta itemprop="name" content="tf.distributions.Dirichlet" />
...
Defined in [`tensorflow/python/ops/distributions/dirichlet.py`](https://www.tensorflow.org/code/tensorflow/python/ops/distributions/dirichlet.py).
