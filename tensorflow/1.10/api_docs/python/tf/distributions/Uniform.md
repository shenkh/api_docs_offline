...
<meta itemprop="name" content="tf.distributions.Uniform" />
...
* Class `tf.distributions.Uniform`



Defined in [`tensorflow/python/ops/distributions/uniform.py`](https://www.tensorflow.org/code/tensorflow/python/ops/distributions/uniform.py).
