...
<meta itemprop="name" content="tf.distributions.DirichletMultinomial" />
...
Defined in [`tensorflow/python/ops/distributions/dirichlet_multinomial.py`](https://www.tensorflow.org/code/tensorflow/python/ops/distributions/dirichlet_multinomial.py).
