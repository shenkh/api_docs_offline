...
Defined in [`tensorflow/keras/applications/mobilenet/__init__.py`](https://www.tensorflow.org/code/tensorflow/keras/applications/mobilenet/__init__.py).
...
[`preprocess_input(...)`](../../../tf/keras/applications/mobilenet/preprocess_input.md): Preprocesses a numpy array encoding a batch of images.
