...
<meta itemprop="name" content="tf.keras.layers.CuDNNLSTM" />
...
Defined in [`tensorflow/python/keras/layers/cudnn_recurrent.py`](https://www.tensorflow.org/code/tensorflow/python/keras/layers/cudnn_recurrent.py).
