...
Defined in [`tensorflow/python/keras/layers/wrappers.py`](https://www.tensorflow.org/code/tensorflow/python/keras/layers/wrappers.py).
...
* <b>`ValueError`</b>: If not initialized with a `Layer` instance or
