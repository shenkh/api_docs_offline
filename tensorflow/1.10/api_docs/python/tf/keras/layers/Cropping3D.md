...
Defined in [`tensorflow/python/keras/layers/convolutional.py`](https://www.tensorflow.org/code/tensorflow/python/keras/layers/convolutional.py).
...
* <b>`cropping`</b>: int, or tuple of 23ints, or tuple of 3 tuples of 2 ints.
