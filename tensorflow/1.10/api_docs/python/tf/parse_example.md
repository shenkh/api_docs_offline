...
<meta itemprop="name" content="tf.parse_example" />
</div>
...
<a href="../tf/float32.md"><code>tf.float32</code></a> if not specified) and shape `(serialized.size(),) + df.shape`.
...
(or <a href="../tf/float32.md"><code>tf.float32</code></a> if not specified) and shape
...
For example, if one expects a <a href="../tf/float32.md"><code>tf.float32</code></a> `VarLenFeature` `ft` and three
