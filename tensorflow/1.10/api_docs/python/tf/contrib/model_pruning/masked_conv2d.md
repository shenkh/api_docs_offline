...
Defined in [`tensorflow/contrib/model_pruning/python/layers/layers.py`](https://www.tensorflow.org/code/tensorflow/contrib/model_pruning/python/layers/layers.py).
