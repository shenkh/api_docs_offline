...
<meta itemprop="name" content="tf.contrib.estimator.RNNEstimator" />
...
Defined in [`tensorflow/contrib/estimator/python/estimator/rnn.py`](https://www.tensorflow.org/code/tensorflow/contrib/estimator/python/estimator/rnn.py).
...
* <b>`head`</b>: A `_Head` instance constructed with a method such as
    <a href="../../../tf/contrib/estimator/multi_label_head.md"><code>tf.contrib.estimator.multi_label_head</code></a>. This specifies the model's
...
* <b>`num_units`</b>: Iterable of integer number of hidden units per RNN layer. If
    ...
    `None`.
* <b>`cell_type`</b>: A subclass of <a href="../../../tf/contrib/rnn/RNNCell.md"><code>tf.nn.rnn_cell.RNNCell</code></a> or a string specifying
...
* <b>`rnn_cell_fn`</b>: A function with one argument, a <a href="../../../tf/estimator/ModeKeys.md"><code>tf.estimator.ModeKeys</code></a>, and
    returns an object of type <a href="../../../tf/contrib/rnn/RNNCell.md"><code>tf.nn.rnn_cell.RNNCell</code></a> that will be used to
    ...
    `num_units` and `cell_type`. Note that <a href="../../../tf/contrib/rnn/MultiRNNCell.md"><code>tf.nn.rnn_cell.MultiRNNCell</code></a> is
