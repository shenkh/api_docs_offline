...
<meta itemprop="name" content="tf.contrib.estimator.BaselineEstimator" />
...
Defined in [`tensorflow/contrib/estimator/python/estimator/baseline.py`](https://www.tensorflow.org/code/tensorflow/contrib/estimator/python/estimator/baseline.py).
