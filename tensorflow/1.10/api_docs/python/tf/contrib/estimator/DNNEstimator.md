...
<meta itemprop="name" content="tf.contrib.estimator.DNNEstimator" />
...
Defined in [`tensorflow/contrib/estimator/python/estimator/dnn.py`](https://www.tensorflow.org/code/tensorflow/contrib/estimator/python/estimator/dnn.py).
