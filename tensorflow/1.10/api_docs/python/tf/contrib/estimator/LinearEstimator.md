...
<meta itemprop="name" content="tf.contrib.estimator.LinearEstimator" />
...
Defined in [`tensorflow/contrib/estimator/python/estimator/linear.py`](https://www.tensorflow.org/code/tensorflow/contrib/estimator/python/estimator/linear.py).
...
* <b>`sparse_combiner`</b>: A string specifying how to reduce if a categorical column
    ...
    <a href="../../../tf/feature_column/linear_model.md">linear_model</a>.
