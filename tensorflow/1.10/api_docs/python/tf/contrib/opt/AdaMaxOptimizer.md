...
<meta itemprop="name" content="tf.contrib.opt.AdaMaxOptimizer" />
...
Defined in [`tensorflow/contrib/opt/python/training/adamax.py`](https://www.tensorflow.org/code/tensorflow/contrib/opt/python/training/adamax.py).
