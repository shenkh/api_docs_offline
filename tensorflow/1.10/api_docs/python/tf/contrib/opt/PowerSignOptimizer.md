...
<meta itemprop="name" content="tf.contrib.opt.PowerSignOptimizer" />
...
Defined in [`tensorflow/contrib/opt/python/training/powersign.py`](https://www.tensorflow.org/code/tensorflow/contrib/opt/python/training/powersign.py).
