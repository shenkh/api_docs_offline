...
<meta itemprop="name" content="tf.contrib.opt.LazyAdamOptimizer" />
...
Inherits From: [`AdamOptimizer`](../../../tf/train/AdamOptimizer.md)



Defined in [`tensorflow/contrib/opt/python/training/lazy_adam_optimizer.py`](https://www.tensorflow.org/code/tensorflow/contrib/opt/python/training/lazy_adam_optimizer.py).
