...
<meta itemprop="name" content="tf.contrib.opt.MovingAverageOptimizer" />
...
Defined in [`tensorflow/contrib/opt/python/training/moving_average_optimizer.py`](https://www.tensorflow.org/code/tensorflow/contrib/opt/python/training/moving_average_optimizer.py).
...
* <b>`ValueError`</b>: If var_list is provided and contains some variables but not
