...
<meta itemprop="name" content="tf.contrib.distributions.BetaWithSoftplusConcentration" />
...
Inherits From: [`Beta`](../../../tf/distributions/Beta.md)



Defined in [`tensorflow/python/ops/distributions/beta.py`](https://www.tensorflow.org/code/tensorflow/python/ops/distributions/beta.py).
