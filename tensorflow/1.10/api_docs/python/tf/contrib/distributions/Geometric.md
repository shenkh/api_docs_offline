...
<meta itemprop="name" content="tf.contrib.distributions.Geometric" />
...
Defined in [`tensorflow/contrib/distributions/python/ops/geometric.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/geometric.py).
...
Construct Geometric distributions. (deprecated)
