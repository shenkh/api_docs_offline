...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/affine_scalar.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/bijectors/affine_scalar.py).
...
Instantiates the `AffineScalar` bijector. (deprecated)
