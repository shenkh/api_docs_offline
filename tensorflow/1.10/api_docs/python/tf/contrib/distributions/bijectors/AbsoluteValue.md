...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/absolute_value.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/bijectors/absolute_value.py).
