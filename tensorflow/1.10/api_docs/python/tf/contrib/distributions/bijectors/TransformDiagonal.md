...
<meta itemprop="name" content="tf.contrib.distributions.bijectors.TransformDiagonal" />
...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/transform_diagonal.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/bijectors/transform_diagonal.py).
...
Instantiates the `TransformDiagonal` bijector. (deprecated)
