...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/permute.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/bijectors/permute.py).
...
safe alternative is to use <a href="../../../../tf/get_variable.md"><code>tf.get_variable</code></a> to achieve "init once" behavior,
i.e.,
