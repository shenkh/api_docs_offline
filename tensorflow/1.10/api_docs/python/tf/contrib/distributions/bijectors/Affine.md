...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/affine.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/bijectors/affine.py).
