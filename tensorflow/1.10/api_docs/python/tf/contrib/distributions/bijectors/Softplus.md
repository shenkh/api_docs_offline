...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/softplus.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/bijectors/softplus.py).
