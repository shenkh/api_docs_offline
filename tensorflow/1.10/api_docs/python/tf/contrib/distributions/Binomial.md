...
<meta itemprop="name" content="tf.contrib.distributions.Binomial" />
...
Defined in [`tensorflow/contrib/distributions/python/ops/binomial.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/binomial.py).
...
Initialize a batch of Binomial distributions. (deprecated)
