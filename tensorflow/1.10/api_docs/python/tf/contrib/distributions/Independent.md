...
<meta itemprop="name" content="tf.contrib.distributions.Independent" />
...
Defined in [`tensorflow/contrib/distributions/python/ops/independent.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/independent.py).
...
* <b>`reinterpreted_batch_ndims`</b>: Scalar, integer number of rightmost batch dims
    ...
    (analogous to <a href="../../../tf/layers/flatten.md"><code>tf.layers.flatten</code></a>).
