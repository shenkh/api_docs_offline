...
Defined in [`tensorflow/contrib/distributions/python/ops/poisson.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/poisson.py).
