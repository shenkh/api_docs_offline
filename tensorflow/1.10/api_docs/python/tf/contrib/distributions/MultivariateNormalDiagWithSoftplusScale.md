...
<meta itemprop="name" content="tf.contrib.distributions.MultivariateNormalDiagWithSoftplusScale" />
...
Inherits From: [`MultivariateNormalDiag`](../../../tf/contrib/distributions/MultivariateNormalDiag.md)



Defined in [`tensorflow/contrib/distributions/python/ops/mvn_diag.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/mvn_diag.py).
