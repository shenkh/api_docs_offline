...
Defined in [`tensorflow/contrib/distributions/python/ops/mixture_same_family.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/mixture_same_family.py).
...
* <b>`mixture_distribution`</b>: <a href="../../../tf/distributions/Categorical.md"><code>tf.distributions.Categorical</code></a>-like instance.
    Manages the probability of selecting components. The number of
    categories must match the rightmost batch dimension of the
    `components_distribution`. Must have either scalar `batch_shape` or
    `batch_shape` matching `components_distribution.batch_shape[:-1]`.
* <b>`components_distribution`</b>: <a href="../../../tf/distributions/Distribution.md"><code>tf.distributions.Distribution</code></a>-like instance.
