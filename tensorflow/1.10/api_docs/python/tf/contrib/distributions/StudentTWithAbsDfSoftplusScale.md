...
<meta itemprop="name" content="tf.contrib.distributions.StudentTWithAbsDfSoftplusScale" />
...
Inherits From: [`StudentT`](../../../tf/distributions/StudentT.md)



Defined in [`tensorflow/python/ops/distributions/student_t.py`](https://www.tensorflow.org/code/tensorflow/python/ops/distributions/student_t.py).
