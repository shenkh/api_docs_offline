...
<meta itemprop="name" content="tf.contrib.distributions.MultivariateNormalFullCovariance" />
...
Inherits From: [`MultivariateNormalTriL`](../../../tf/contrib/distributions/MultivariateNormalTriL.md)



Defined in [`tensorflow/contrib/distributions/python/ops/mvn_full_covariance.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/mvn_full_covariance.py).
