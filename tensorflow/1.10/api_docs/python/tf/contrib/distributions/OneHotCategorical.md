...
<meta itemprop="name" content="tf.contrib.distributions.OneHotCategorical" />
...
Defined in [`tensorflow/contrib/distributions/python/ops/onehot_categorical.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/onehot_categorical.py).
...
Initialize OneHotCategorical distributions using class log-probabilities. (deprecated)
