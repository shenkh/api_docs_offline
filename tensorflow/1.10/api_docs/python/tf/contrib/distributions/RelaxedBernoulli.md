...
random variable followed by a <a href="../../../tf/sigmoid.md"><code>tf.sigmoid</code></a> op, one solution is to treat
the Logistic as the random variable and <a href="../../../tf/sigmoid.md"><code>tf.sigmoid</code></a> as downstream. The
KL divergences of two Logistics, which are always followed by a <a href="../../../tf/sigmoid.md"><code>tf.sigmoid</code></a>
