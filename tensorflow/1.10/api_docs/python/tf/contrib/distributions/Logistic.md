...
<meta itemprop="name" content="tf.contrib.distributions.Logistic" />
...
Defined in [`tensorflow/contrib/distributions/python/ops/logistic.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/logistic.py).
