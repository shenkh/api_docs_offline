...
<meta itemprop="name" content="tf.contrib.distributions.SinhArcsinh" />
...
Defined in [`tensorflow/contrib/distributions/python/ops/sinh_arcsinh.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/sinh_arcsinh.py).
