...
<meta itemprop="name" content="tf.contrib.distributions.VectorSinhArcsinhDiag" />
...
Defined in [`tensorflow/contrib/distributions/python/ops/vector_sinh_arcsinh_diag.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/vector_sinh_arcsinh_diag.py).
