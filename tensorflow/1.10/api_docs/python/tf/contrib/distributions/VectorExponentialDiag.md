...
<meta itemprop="name" content="tf.contrib.distributions.VectorExponentialDiag" />
...
Defined in [`tensorflow/contrib/distributions/python/ops/vector_exponential_diag.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/vector_exponential_diag.py).
...
Construct Vector Exponential distribution supported on a subset of `R^k`. (deprecated)
