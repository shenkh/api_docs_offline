...
<meta itemprop="name" content="tf.contrib.distributions.ConditionalTransformedDistribution" />
...
Inherits From: [`ConditionalDistribution`](../../../tf/contrib/distributions/ConditionalDistribution.md), [`TransformedDistribution`](../../../tf/contrib/distributions/TransformedDistribution.md)



Defined in [`tensorflow/contrib/distributions/python/ops/conditional_transformed_distribution.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/conditional_transformed_distribution.py).
