...
`call` methods to instantiate variables via <a href="../../../tf/get_variable.md"><code>tf.get_variable</code></a>.  The underlying
...
`call` methods do not access Variables <a href="../../../tf/get_variable.md"><code>tf.get_variable</code></a>.
