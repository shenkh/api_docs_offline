...
<meta itemprop="name" content="tf.contrib.rnn.GRUBlockCellV2" />
...
Inherits From: [`GRUBlockCell`](../../../tf/contrib/rnn/GRUBlockCell.md)
...
* <b>`name`</b>: String, the name of the layer. Layers with the same name will
    ...
    with <a href="../../../tf/contrib/rnn/GRUCell.md"><code>tf.nn.rnn_cell.GRUCell</code></a>.
