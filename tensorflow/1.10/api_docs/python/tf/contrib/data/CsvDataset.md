...
<meta itemprop="name" content="tf.contrib.data.CsvDataset" />
...
* <b>`header`</b>: (Optional.) A <a href="../../../tf/bool.md"><code>tf.bool</code></a> scalar indicating whether the CSV file(s)
    have header line(s) that should be skipped when parsing. Defaults to
    `False`.
* <b>`field_delim`</b>: (Optional.) A <a href="../../../tf/string.md"><code>tf.string</code></a> scalar containing the delimiter
    character that separates fields in a record. Defaults to `","`.
* <b>`use_quote_delim`</b>: (Optional.) A <a href="../../../tf/bool.md"><code>tf.bool</code></a> scalar. If `False`, treats
...
* <b>`na_value`</b>: (Optional.) A <a href="../../../tf/string.md"><code>tf.string</code></a> scalar indicating a value that will
