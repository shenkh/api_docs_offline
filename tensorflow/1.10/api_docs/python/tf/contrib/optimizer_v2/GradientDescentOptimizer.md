...
<meta itemprop="name" content="tf.contrib.optimizer_v2.GradientDescentOptimizer" />
...
Defined in [`tensorflow/contrib/optimizer_v2/gradient_descent.py`](https://www.tensorflow.org/code/tensorflow/contrib/optimizer_v2/gradient_descent.py).
...
* <b>`learning_rate`</b>: A float hyperparameter. The learning rate to use.
