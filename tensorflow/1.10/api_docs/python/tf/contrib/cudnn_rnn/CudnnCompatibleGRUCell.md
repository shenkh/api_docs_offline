...
Inherits From: [`GRUCell`](../../../tf/contrib/rnn/GRUCell.md)
...
A GRU impl akin to <a href="../../../tf/contrib/rnn/GRUCell.md"><code>tf.nn.rnn_cell.GRUCell</code></a> to use along with
...
Other GRU (see <a href="../../../tf/contrib/rnn/GRUCell.md"><code>tf.nn.rnn_cell.GRUCell</code></a> and <a href="../../../tf/contrib/rnn/GRUBlockCell.md"><code>tf.contrib.rnn.GRUBlockCell</code></a>):
```python
# new memory gate
