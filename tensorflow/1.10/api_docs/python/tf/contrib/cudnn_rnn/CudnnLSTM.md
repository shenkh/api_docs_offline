...
Defined in [`tensorflow/contrib/cudnn_rnn/python/layers/cudnn_rnn.py`](https://www.tensorflow.org/code/tensorflow/contrib/cudnn_rnn/python/layers/cudnn_rnn.py).
...
* <b>`seed`</b>: the op seed used for initializing dropout. See <a href="../../../tf/set_random_seed.md"><code>tf.set_random_seed</code></a>
      for behavior.
