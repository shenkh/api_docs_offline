...
Defined in [`tensorflow/contrib/kernel_methods/python/kernel_estimators.py`](https://www.tensorflow.org/code/tensorflow/contrib/kernel_methods/python/kernel_estimators.py).
