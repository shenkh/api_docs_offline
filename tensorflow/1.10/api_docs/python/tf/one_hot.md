...
value <a href="../tf/float32.md"><code>tf.float32</code></a>.

Note: If a non-numeric data type output is desired (<a href="../tf/string.md"><code>tf.string</code></a>, <a href="../tf/bool.md"><code>tf.bool</code></a>,
