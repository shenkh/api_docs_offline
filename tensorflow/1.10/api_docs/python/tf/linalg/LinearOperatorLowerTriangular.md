...
Defined in [`tensorflow/python/ops/linalg/linear_operator_lower_triangular.py`](https://www.tensorflow.org/code/tensorflow/python/ops/linalg/linear_operator_lower_triangular.py).
