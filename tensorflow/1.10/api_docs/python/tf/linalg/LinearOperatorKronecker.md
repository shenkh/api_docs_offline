...
Defined in [`tensorflow/python/ops/linalg/linear_operator_kronecker.py`](https://www.tensorflow.org/code/tensorflow/python/ops/linalg/linear_operator_kronecker.py).
