...
Defined in [`tensorflow/python/ops/linalg/linear_operator_low_rank_update.py`](https://www.tensorflow.org/code/tensorflow/python/ops/linalg/linear_operator_low_rank_update.py).
