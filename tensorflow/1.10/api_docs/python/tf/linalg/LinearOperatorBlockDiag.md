...
* Class `tf.contrib.linalg.LinearOperatorBlockDiag`
* Class `tf.linalg.LinearOperatorBlockDiag`



Defined in [`tensorflow/python/ops/linalg/linear_operator_block_diag.py`](https://www.tensorflow.org/code/tensorflow/python/ops/linalg/linear_operator_block_diag.py).
