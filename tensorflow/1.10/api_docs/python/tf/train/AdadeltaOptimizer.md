...
<meta itemprop="name" content="tf.train.AdadeltaOptimizer" />
...
Defined in [`tensorflow/python/training/adadelta.py`](https://www.tensorflow.org/code/tensorflow/python/training/adadelta.py).
