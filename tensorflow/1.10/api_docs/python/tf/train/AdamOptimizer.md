...
<meta itemprop="name" content="tf.train.AdamOptimizer" />
...
Defined in [`tensorflow/python/training/adam.py`](https://www.tensorflow.org/code/tensorflow/python/training/adam.py).
