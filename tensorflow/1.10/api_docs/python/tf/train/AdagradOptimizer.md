...
<meta itemprop="name" content="tf.train.AdagradOptimizer" />
...
Defined in [`tensorflow/python/training/adagrad.py`](https://www.tensorflow.org/code/tensorflow/python/training/adagrad.py).
