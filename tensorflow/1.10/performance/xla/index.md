...
by using XLA via <a href="../../performance/xla/jit.md">just-in-time (JIT) compilation</a> or <a href="../../performance/xla/tfcompile.md">ahead-of-time (AOT) compilation</a>. Developers targeting new hardware accelerators are
...
<a href="../../performance/xla/operation_semantics.md">Operation Semantics</a> page. It
...
easy to slot in an alternative backend to <a href="../../performance/xla/developing_new_backend.md">target some novel HW architecture</a>. The CPU backend for x64 and ARM64 as
...
XLA currently supports <a href="../../performance/xla/jit.md">JIT compilation</a> on x86-64 and NVIDIA GPUs; and
<a href="../../performance/xla/tfcompile.md">AOT compilation</a> for x86-64 and ARM.
