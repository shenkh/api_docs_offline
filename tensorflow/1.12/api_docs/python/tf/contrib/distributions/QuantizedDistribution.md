...
Defined in [`tensorflow/contrib/distributions/python/ops/quantized_distribution.py`](/code/stable/tensorflow/contrib/distributions/python/ops/quantized_distribution.py).
