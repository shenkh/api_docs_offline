...
Defined in [`tensorflow/contrib/distributions/python/ops/conditional_distribution.py`](/code/stable/tensorflow/contrib/distributions/python/ops/conditional_distribution.py).
