...
Defined in [`tensorflow/contrib/distributions/python/ops/mvn_diag_plus_low_rank.py`](/code/stable/tensorflow/contrib/distributions/python/ops/mvn_diag_plus_low_rank.py).
