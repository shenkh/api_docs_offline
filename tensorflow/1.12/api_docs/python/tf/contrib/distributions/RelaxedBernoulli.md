...
Defined in [`tensorflow/contrib/distributions/python/ops/relaxed_bernoulli.py`](/code/stable/tensorflow/contrib/distributions/python/ops/relaxed_bernoulli.py).
...
random variable followed by a <a href="../../../tf/math/sigmoid.md"><code>tf.sigmoid</code></a> op, one solution is to treat
the Logistic as the random variable and <a href="../../../tf/math/sigmoid.md"><code>tf.sigmoid</code></a> as downstream. The
KL divergences of two Logistics, which are always followed by a <a href="../../../tf/math/sigmoid.md"><code>tf.sigmoid</code></a>
