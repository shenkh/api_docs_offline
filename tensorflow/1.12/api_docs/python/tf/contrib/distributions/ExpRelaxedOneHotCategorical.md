...
Defined in [`tensorflow/contrib/distributions/python/ops/relaxed_onehot_categorical.py`](/code/stable/tensorflow/contrib/distributions/python/ops/relaxed_onehot_categorical.py).
