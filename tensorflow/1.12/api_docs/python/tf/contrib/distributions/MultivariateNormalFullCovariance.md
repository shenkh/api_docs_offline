...
Defined in [`tensorflow/contrib/distributions/python/ops/mvn_full_covariance.py`](/code/stable/tensorflow/contrib/distributions/python/ops/mvn_full_covariance.py).
