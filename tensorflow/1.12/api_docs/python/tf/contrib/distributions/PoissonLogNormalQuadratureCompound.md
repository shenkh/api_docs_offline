...
<meta itemprop="name" content="tf.contrib.distributions.PoissonLogNormalQuadratureCompound" />
...
Defined in [`tensorflow/contrib/distributions/python/ops/poisson_lognormal.py`](/code/stable/tensorflow/contrib/distributions/python/ops/poisson_lognormal.py).
...
Constructs the PoissonLogNormalQuadratureCompound`. (deprecated)
