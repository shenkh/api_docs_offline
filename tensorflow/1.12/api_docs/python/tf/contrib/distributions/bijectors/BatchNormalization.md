...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/batch_normalization.py`](/code/stable/tensorflow/contrib/distributions/python/ops/bijectors/batch_normalization.py).
