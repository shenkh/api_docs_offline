...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/ordered.py`](/code/stable/tensorflow/contrib/distributions/python/ops/bijectors/ordered.py).
