...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/softsign.py`](/code/stable/tensorflow/contrib/distributions/python/ops/bijectors/softsign.py).
