...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/softplus.py`](/code/stable/tensorflow/contrib/distributions/python/ops/bijectors/softplus.py).
