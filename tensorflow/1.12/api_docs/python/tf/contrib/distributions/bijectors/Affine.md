...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/affine.py`](/code/stable/tensorflow/contrib/distributions/python/ops/bijectors/affine.py).
