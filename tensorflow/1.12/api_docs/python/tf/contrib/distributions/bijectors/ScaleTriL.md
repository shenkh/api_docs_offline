...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/scale_tril.py`](/code/stable/tensorflow/contrib/distributions/python/ops/bijectors/scale_tril.py).
