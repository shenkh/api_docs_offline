...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/matrix_inverse_tril.py`](/code/stable/tensorflow/contrib/distributions/python/ops/bijectors/matrix_inverse_tril.py).
