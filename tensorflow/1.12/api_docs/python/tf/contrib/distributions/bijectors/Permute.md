...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/permute.py`](/code/stable/tensorflow/contrib/distributions/python/ops/bijectors/permute.py).
