...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/absolute_value.py`](/code/stable/tensorflow/contrib/distributions/python/ops/bijectors/absolute_value.py).
