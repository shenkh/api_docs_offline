...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/softmax_centered.py`](/code/stable/tensorflow/contrib/distributions/python/ops/bijectors/softmax_centered.py).
