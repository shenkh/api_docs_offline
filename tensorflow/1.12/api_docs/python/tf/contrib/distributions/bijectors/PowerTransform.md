...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/power_transform.py`](/code/stable/tensorflow/contrib/distributions/python/ops/bijectors/power_transform.py).
