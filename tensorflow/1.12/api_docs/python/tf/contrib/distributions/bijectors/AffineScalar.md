...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/affine_scalar.py`](/code/stable/tensorflow/contrib/distributions/python/ops/bijectors/affine_scalar.py).
