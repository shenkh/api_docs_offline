...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/transform_diagonal.py`](/code/stable/tensorflow/contrib/distributions/python/ops/bijectors/transform_diagonal.py).
