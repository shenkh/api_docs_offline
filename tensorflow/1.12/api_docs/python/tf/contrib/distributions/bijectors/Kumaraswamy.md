...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/kumaraswamy.py`](/code/stable/tensorflow/contrib/distributions/python/ops/bijectors/kumaraswamy.py).
