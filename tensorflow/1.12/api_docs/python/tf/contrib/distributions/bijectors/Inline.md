...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/inline.py`](/code/stable/tensorflow/contrib/distributions/python/ops/bijectors/inline.py).
