...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/sigmoid.py`](/code/stable/tensorflow/contrib/distributions/python/ops/bijectors/sigmoid.py).
