...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/reshape.py`](/code/stable/tensorflow/contrib/distributions/python/ops/bijectors/reshape.py).
