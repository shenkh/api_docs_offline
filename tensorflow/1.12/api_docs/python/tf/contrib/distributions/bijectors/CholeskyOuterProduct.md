...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/cholesky_outer_product.py`](/code/stable/tensorflow/contrib/distributions/python/ops/bijectors/cholesky_outer_product.py).
