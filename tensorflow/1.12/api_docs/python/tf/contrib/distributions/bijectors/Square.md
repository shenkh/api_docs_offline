...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/square.py`](/code/stable/tensorflow/contrib/distributions/python/ops/bijectors/square.py).
