...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/invert.py`](/code/stable/tensorflow/contrib/distributions/python/ops/bijectors/invert.py).
