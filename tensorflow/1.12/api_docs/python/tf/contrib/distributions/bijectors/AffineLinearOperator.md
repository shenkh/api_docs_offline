...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/affine_linear_operator.py`](/code/stable/tensorflow/contrib/distributions/python/ops/bijectors/affine_linear_operator.py).
