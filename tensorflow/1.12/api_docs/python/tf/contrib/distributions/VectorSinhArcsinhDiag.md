...
Defined in [`tensorflow/contrib/distributions/python/ops/vector_sinh_arcsinh_diag.py`](/code/stable/tensorflow/contrib/distributions/python/ops/vector_sinh_arcsinh_diag.py).
