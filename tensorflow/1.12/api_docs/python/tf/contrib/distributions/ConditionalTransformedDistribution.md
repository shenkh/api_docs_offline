...
Defined in [`tensorflow/contrib/distributions/python/ops/conditional_transformed_distribution.py`](/code/stable/tensorflow/contrib/distributions/python/ops/conditional_transformed_distribution.py).
