...
Defined in [`tensorflow/contrib/distributions/python/ops/onehot_categorical.py`](/code/stable/tensorflow/contrib/distributions/python/ops/onehot_categorical.py).
