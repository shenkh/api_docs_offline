...
Defined in [`tensorflow/contrib/distributions/python/ops/vector_exponential_diag.py`](/code/stable/tensorflow/contrib/distributions/python/ops/vector_exponential_diag.py).
