...
Defined in [`tensorflow/contrib/distributions/python/ops/vector_laplace_diag.py`](/code/stable/tensorflow/contrib/distributions/python/ops/vector_laplace_diag.py).
