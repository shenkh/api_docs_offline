...
Defined in [`tensorflow/contrib/distributions/python/ops/negative_binomial.py`](/code/stable/tensorflow/contrib/distributions/python/ops/negative_binomial.py).
