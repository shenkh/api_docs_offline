...
<meta itemprop="name" content="tf.contrib.distributions.WishartCholesky" />
...
Defined in [`tensorflow/contrib/distributions/python/ops/wishart.py`](/code/stable/tensorflow/contrib/distributions/python/ops/wishart.py).
