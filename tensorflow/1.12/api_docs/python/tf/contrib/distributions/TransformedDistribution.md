...
Defined in [`tensorflow/python/ops/distributions/transformed_distribution.py`](/code/stable/tensorflow/python/ops/distributions/transformed_distribution.py).
