...
Defined in [`tensorflow/contrib/constrained_optimization/python/constrained_optimizer.py`](/code/stable/tensorflow/contrib/constrained_optimization/python/constrained_optimizer.py).
