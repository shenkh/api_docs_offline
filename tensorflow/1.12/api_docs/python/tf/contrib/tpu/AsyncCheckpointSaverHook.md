...
<meta itemprop="name" content="tf.contrib.tpu.AsyncCheckpointSaverHook" />
...
Inherits From: [`CheckpointSaverHook`](../../../tf/train/CheckpointSaverHook.md)



Defined in [`tensorflow/contrib/tpu/python/tpu/async_checkpoint.py`](/code/stable/tensorflow/contrib/tpu/python/tpu/async_checkpoint.py).
