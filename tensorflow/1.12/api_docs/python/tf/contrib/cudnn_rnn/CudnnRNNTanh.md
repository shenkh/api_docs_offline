...
Defined in [`tensorflow/contrib/cudnn_rnn/python/layers/cudnn_rnn.py`](/code/stable/tensorflow/contrib/cudnn_rnn/python/layers/cudnn_rnn.py).
...
* <b>`seed`</b>: the op seed used for initializing dropout. See <a href="../../../tf/random/set_random_seed.md"><code>tf.set_random_seed</code></a>
      for behavior.
