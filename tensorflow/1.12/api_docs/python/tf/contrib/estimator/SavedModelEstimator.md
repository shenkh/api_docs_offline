...
Defined in [`tensorflow/contrib/estimator/python/estimator/saved_model_estimator.py`](/code/stable/tensorflow/contrib/estimator/python/estimator/saved_model_estimator.py).
