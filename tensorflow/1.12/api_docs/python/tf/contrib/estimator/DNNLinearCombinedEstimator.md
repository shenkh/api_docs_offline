...
Defined in [`tensorflow/contrib/estimator/python/estimator/dnn_linear_combined.py`](/code/stable/tensorflow/contrib/estimator/python/estimator/dnn_linear_combined.py).
