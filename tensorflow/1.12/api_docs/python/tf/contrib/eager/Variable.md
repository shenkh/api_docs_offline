...
<meta itemprop="name" content="tf.contrib.eager.Variable" />
...
Defined in [`tensorflow/python/ops/resource_variable_ops.py`](/code/stable/tensorflow/python/ops/resource_variable_ops.py).
