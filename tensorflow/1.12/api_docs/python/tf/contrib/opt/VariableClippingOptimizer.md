...
Defined in [`tensorflow/contrib/opt/python/training/variable_clipping_optimizer.py`](/code/stable/tensorflow/contrib/opt/python/training/variable_clipping_optimizer.py).
...
* <b>`vars_to_clip_dims`</b>: A dict with keys as Variables and values as lists
    ...
    <a href="../../../tf/clip_by_norm.md"><code>tf.clip_by_norm</code></a> for more details.
