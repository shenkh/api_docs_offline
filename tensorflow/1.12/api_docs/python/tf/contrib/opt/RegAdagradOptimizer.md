...
Defined in [`tensorflow/contrib/opt/python/training/reg_adagrad_optimizer.py`](/code/stable/tensorflow/contrib/opt/python/training/reg_adagrad_optimizer.py).
