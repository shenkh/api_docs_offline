...
Defined in [`tensorflow/contrib/opt/python/training/moving_average_optimizer.py`](/code/stable/tensorflow/contrib/opt/python/training/moving_average_optimizer.py).
