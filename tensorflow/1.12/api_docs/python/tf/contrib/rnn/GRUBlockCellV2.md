...
Defined in [`tensorflow/contrib/rnn/python/ops/gru_ops.py`](/code/stable/tensorflow/contrib/rnn/python/ops/gru_ops.py).
...
* <b>`name`</b>: String, the name of the layer. Layers with the same name will
    ...
    with <a href="../../../tf/nn/rnn_cell/GRUCell.md"><code>tf.nn.rnn_cell.GRUCell</code></a>.
