...
Defined in [`tensorflow/contrib/rnn/python/ops/lstm_ops.py`](/code/stable/tensorflow/contrib/rnn/python/ops/lstm_ops.py).
...
* <b>`name`</b>: String, the name of the layer. Layers with the same name will
    ...
    with <a href="../../../tf/nn/rnn_cell/LSTMCell.md"><code>tf.nn.rnn_cell.LSTMCell</code></a>.
