...
<meta itemprop="name" content="tf.contrib.learn.LinearRegressor" />
...
Defined in [`tensorflow/contrib/learn/python/learn/estimators/linear.py`](/code/stable/tensorflow/contrib/learn/python/learn/estimators/linear.py).
