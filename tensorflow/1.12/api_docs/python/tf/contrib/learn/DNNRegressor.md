...
<meta itemprop="name" content="tf.contrib.learn.DNNRegressor" />
...
Defined in [`tensorflow/contrib/learn/python/learn/estimators/dnn.py`](/code/stable/tensorflow/contrib/learn/python/learn/estimators/dnn.py).
