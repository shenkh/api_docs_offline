...
<meta itemprop="name" content="tf.distributions.Gamma" />
...
Defined in [`tensorflow/python/ops/distributions/gamma.py`](/code/stable/tensorflow/python/ops/distributions/gamma.py).
...
`rate` is very large. See note in <a href="../../tf/random/gamma.md"><code>tf.random_gamma</code></a> docstring.
