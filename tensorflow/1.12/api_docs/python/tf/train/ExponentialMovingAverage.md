...
Defined in [`tensorflow/python/training/moving_averages.py`](/code/stable/tensorflow/python/training/moving_averages.py).
...
*  Build a model normally but load the checkpoint files to evaluate by using
   ...
   the <a href="../../tf/train/Saver.md"><code>tf.train.Saver</code></a> for more
