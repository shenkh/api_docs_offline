...
* <b>`summary_op`</b>: `Tensor` of type `string` containing the serialized `Summary`
      ...
      by TF summary methods like <a href="../../tf/summary/scalar.md"><code>tf.summary.scalar</code></a> or
      <a href="../../tf/summary/merge_all.md"><code>tf.summary.merge_all</code></a>. It can be passed in as one tensor; if more
