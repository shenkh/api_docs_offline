...
<a href="../../api_docs/python/tf/estimator/Estimator.md#train"><code>tf.estimator.Estimator.train</code></a>. In code, this might look like the following
...
end, the <a href="../../api_docs/python/tf/data.md"><code>tf.data</code></a> API provides the <a href="../../api_docs/python/tf/contrib/data/map_and_batch.md"><code>tf.contrib.data.map_and_batch</code></a>
...
API offers the <a href="../../api_docs/python/tf/contrib/data/parallel_interleave.md"><code>tf.contrib.data.parallel_interleave</code></a> transformation. Use this
...
<a href="../../api_docs/python/tf/contrib/data/parallel_interleave.md"><code>tf.contrib.data.parallel_interleave</code></a> for details).
...
<a href="../../api_docs/python/tf/contrib/data/shuffle_and_repeat.md"><code>tf.contrib.data.shuffle_and_repeat</code></a> transformation, which combines the best of
