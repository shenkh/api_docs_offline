...
is, of course, numbers (for example, <a href="../api_docs/python/tf.md#float32"><code>tf.float32</code></a>). After all, every neuron in
...
a numerical value with the default data type (<a href="../api_docs/python/tf.md#float32"><code>tf.float32</code></a>) as input to your
model:
