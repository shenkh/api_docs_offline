...
graph. The graph is composed of two types of objects.
  ...
  * <a href="../api_docs/python/tf/Operation.md"><code>tf.Operation</code></a> (or "ops"): The nodes of the graph.
    Operations describe calculations that consume and produce tensors.
  * <a href="../api_docs/python/tf/Tensor.md"><code>tf.Tensor</code></a>: The edges in the graph. These represent the values
...
For example, the following code calls <a href="../api_docs/python/tf/random/uniform.md"><code>tf.random_uniform</code></a> to produce a
...
the <a href="../api_docs/python/tf/InteractiveSession.md#run"><code>tf.Session.run</code></a> method to feed concrete values to the placeholders:
...
Placeholders work for simple experiments, but <a href="../api_docs/python/tf/data.md"><code>tf.data</code></a> are the
...
<a href="../api_docs/python/tf/data/Iterator.md#get_next"><code>tf.data.Iterator.get_next</code></a> method.

The simplest way to create an Iterator is with the
<a href="../api_docs/python/tf/data/Dataset.md#make_one_shot_iterator"><code>tf.data.Dataset.make_one_shot_iterator</code></a> method.
...
<a href="../api_docs/python/tf/errors/OutOfRangeError.md"><code>tf.errors.OutOfRangeError</code></a>. For example, the following code
...
the same input.  <a href="../api_docs/python/tf/layers.md"><code>tf.layers</code></a> are the preferred way to add trainable
...
The following code creates a <a href="../api_docs/python/tf/layers/Dense.md"><code>tf.layers.Dense</code></a> layer that takes a
...
Important: Calling <a href="../api_docs/python/tf/initializers/global_variables.md"><code>tf.global_variables_initializer</code></a> only
...
initialized. Categorical columns use <a href="../api_docs/python/tf/contrib/lookup.md"><code>tf.contrib.lookup</code></a>
internally and these require a separate initialization op,
<a href="../api_docs/python/tf/initializers/tables_initializer.md"><code>tf.tables_initializer</code></a>.
