...
class MyReaderDataset(tf.data.Dataset):
  ...
  # <a href="../../api_docs/python/tf.md#string"><code>tf.string</code></a> tensor. Change these properties to match the `output_dtypes()`
...
from a <a href="../../api_docs/python/tf/io/parse_single_example.md"><code>tf.parse_single_example</code></a> op and call <a href="../../api_docs/python/tf/image/decode_jpeg.md"><code>tf.image.decode_jpeg</code></a>,
