...
communication, see:
[<a href="../../api_docs/python/tf/contrib/nccl.md"><code>tf.contrib.nccl</code></a>](https://github.com/tensorflow/tensorflow/blob/master/tensorflow/python/ops/nccl_ops.py).
