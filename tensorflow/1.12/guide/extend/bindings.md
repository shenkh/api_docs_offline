...
Feature                                        | Python                                                      | C
:--------------------------------------------- | :---------------------------------------------------------- | :--
Run a predefined Graph                         | <a href="../../api_docs/python/tf/graph_util/import_graph_def.md"><code>tf.import_graph_def</code></a>, <a href="../../api_docs/python/tf/Session.md"><code>tf.Session</code></a>                         | `TF_GraphImportGraphDef`, `TF_NewSession`
