...
Queues, such as <a href="../../api_docs/python/tf/FIFOQueue.md"><code>tf.FIFOQueue</code></a>
...
We recommend using the <a href="../../api_docs/python/tf/data/Dataset.md#shuffle"><code>tf.data.Dataset.shuffle</code></a>
and <a href="../../api_docs/python/tf/data/Dataset.md#batch"><code>tf.data.Dataset.batch</code></a> methods of a
<a href="../../api_docs/python/tf/data/Dataset.md"><code>tf.data.Dataset</code></a> to accomplish this. However, if you'd prefer
