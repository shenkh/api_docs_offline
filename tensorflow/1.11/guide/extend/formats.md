...
use <a href="../../api_docs/python/tf/data/Dataset.md#map"><code>tf.data.Dataset.map</code></a> and <a href="../../api_docs/python/tf/decode_csv.md"><code>tf.decode_csv</code></a> to parses the CSV records from
...
<a href="../../api_docs/python/tf/image/decode_png.md"><code>tf.image.decode_png</code></a>, or <a href="../../api_docs/python/tf/io/decode_raw.md"><code>tf.decode_raw</code></a>.  It is common to take the output
of <a href="../../api_docs/python/tf/io/decode_raw.md"><code>tf.decode_raw</code></a> and use <a href="../../api_docs/python/tf/slice.md"><code>tf.slice</code></a> and <a href="../../api_docs/python/tf/manip/reshape.md"><code>tf.reshape</code></a> to extract pieces.
