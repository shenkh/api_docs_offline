...
<a href="../../api_docs/python/tf/DType.md"><code>tf.DType</code></a> used for inputs and outputs.)
...
* `{<type1>, <type2>}`: The value is of type `type`, and must be one of
  ...
  <a href="../../api_docs/python/tf/DType.md"><code>tf.DType</code></a>.  You don't specify
...
use <a href="../../api_docs/python/tf/DType.md"><code>tf.DType</code></a>.
...
* For a sequence of tensors with the same type: `<number> * <type>`, where
  ...
  either be a <a href="../../api_docs/python/tf/DType.md"><code>tf.DType</code></a>,
