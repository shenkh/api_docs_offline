...
Defined in [`tensorflow/python/keras/layers/recurrent.py`](https://www.tensorflow.org/code/tensorflow/python/keras/layers/recurrent.py).

Long Short-Term Memory layer - Hochreiter 1997.

 Note that this cell is not optimized for performance on GPU. Please use
<a href="../../../tf/keras/layers/CuDNNLSTM.md"><code>tf.keras.layers.CuDNNLSTM</code></a> for better performance on GPU.
