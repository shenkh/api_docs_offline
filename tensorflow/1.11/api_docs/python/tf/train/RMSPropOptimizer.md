...
<meta itemprop="name" content="tf.train.RMSPropOptimizer" />
...
Defined in [`tensorflow/python/training/rmsprop.py`](https://www.tensorflow.org/code/tensorflow/python/training/rmsprop.py).
