...
<meta itemprop="name" content="tf.train.GradientDescentOptimizer" />
...
Defined in [`tensorflow/python/training/gradient_descent.py`](https://www.tensorflow.org/code/tensorflow/python/training/gradient_descent.py).
