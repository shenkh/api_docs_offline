...
<meta itemprop="name" content="tf.train.ProximalGradientDescentOptimizer" />
...
Defined in [`tensorflow/python/training/proximal_gradient_descent.py`](https://www.tensorflow.org/code/tensorflow/python/training/proximal_gradient_descent.py).
