...
<meta itemprop="name" content="tf.train.MomentumOptimizer" />
...
Defined in [`tensorflow/python/training/momentum.py`](https://www.tensorflow.org/code/tensorflow/python/training/momentum.py).
