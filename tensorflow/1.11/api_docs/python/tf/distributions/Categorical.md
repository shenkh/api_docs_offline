...
<meta itemprop="name" content="tf.distributions.Categorical" />
...
Defined in [`tensorflow/python/ops/distributions/categorical.py`](https://www.tensorflow.org/code/tensorflow/python/ops/distributions/categorical.py).
