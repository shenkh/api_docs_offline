...
<meta itemprop="name" content="tf.distributions.Multinomial" />
...
Defined in [`tensorflow/python/ops/distributions/multinomial.py`](https://www.tensorflow.org/code/tensorflow/python/ops/distributions/multinomial.py).
