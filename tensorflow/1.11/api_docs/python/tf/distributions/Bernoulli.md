...
<meta itemprop="name" content="tf.distributions.Bernoulli" />
...
* Class `tf.distributions.Bernoulli`



Defined in [`tensorflow/python/ops/distributions/bernoulli.py`](https://www.tensorflow.org/code/tensorflow/python/ops/distributions/bernoulli.py).
