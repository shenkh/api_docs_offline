...
Defined in [`tensorflow/python/data/ops/dataset_ops.py`](https://www.tensorflow.org/code/tensorflow/python/data/ops/dataset_ops.py).

See the guides: [Reading data > `tf.data` API](../../../../api_guides/python/reading_data.md#_tf_data_API), [Threading and Queues > Queue usage overview](../../../../api_guides/python/threading_and_queues.md#Queue_usage_overview)
