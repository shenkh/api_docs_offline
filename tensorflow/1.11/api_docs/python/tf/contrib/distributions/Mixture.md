...
<meta itemprop="name" content="tf.contrib.distributions.Mixture" />
...
Defined in [`tensorflow/contrib/distributions/python/ops/mixture.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/mixture.py).
