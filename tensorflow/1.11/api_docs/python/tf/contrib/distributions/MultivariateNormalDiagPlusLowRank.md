...
<meta itemprop="name" content="tf.contrib.distributions.MultivariateNormalDiagPlusLowRank" />
...
Defined in [`tensorflow/contrib/distributions/python/ops/mvn_diag_plus_low_rank.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/mvn_diag_plus_low_rank.py).
