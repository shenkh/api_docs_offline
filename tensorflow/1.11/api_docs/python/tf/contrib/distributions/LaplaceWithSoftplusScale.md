...
<meta itemprop="name" content="tf.contrib.distributions.LaplaceWithSoftplusScale" />
...
Inherits From: [`Laplace`](../../../tf/distributions/Laplace.md)



Defined in [`tensorflow/python/ops/distributions/laplace.py`](https://www.tensorflow.org/code/tensorflow/python/ops/distributions/laplace.py).
