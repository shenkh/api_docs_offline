...
<meta itemprop="name" content="tf.contrib.distributions.Autoregressive" />
...
Defined in [`tensorflow/contrib/distributions/python/ops/autoregressive.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/autoregressive.py).
...
constructs a <a href="../../../tf/distributions/Distribution.md"><code>tf.distributions.Distribution</code></a>-like instance, and `x0` is a
...
Construct an `Autoregressive` distribution. (deprecated)
...
* <b>`distribution_fn`</b>: Python `callable` which constructs a
    <a href="../../../tf/distributions/Distribution.md"><code>tf.distributions.Distribution</code></a>-like instance from a `Tensor` (e.g.,
