...
<meta itemprop="name" content="tf.contrib.distributions.Chi2WithAbsDf" />
...
Inherits From: [`Chi2`](../../../tf/contrib/distributions/Chi2.md)



Defined in [`tensorflow/contrib/distributions/python/ops/chi2.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/chi2.py).
