...
<meta itemprop="name" content="tf.contrib.distributions.ExpRelaxedOneHotCategorical" />
...
Defined in [`tensorflow/contrib/distributions/python/ops/relaxed_onehot_categorical.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/relaxed_onehot_categorical.py).
...
followed by a <a href="../../../tf/math/exp.md"><code>tf.exp</code></a> op, is equivalent to evaluating KL divergences of
...
are followed by a <a href="../../../tf/math/exp.md"><code>tf.exp</code></a> op, then they are distributed as a relaxed onehot
categorical.
