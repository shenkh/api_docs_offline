...
<meta itemprop="name" content="tf.contrib.distributions.ConditionalDistribution" />
...
Defined in [`tensorflow/contrib/distributions/python/ops/conditional_distribution.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/conditional_distribution.py).
