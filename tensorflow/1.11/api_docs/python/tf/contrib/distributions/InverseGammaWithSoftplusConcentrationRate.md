...
<meta itemprop="name" content="tf.contrib.distributions.InverseGammaWithSoftplusConcentrationRate" />
...
Inherits From: [`InverseGamma`](../../../tf/contrib/distributions/InverseGamma.md)



Defined in [`tensorflow/contrib/distributions/python/ops/inverse_gamma.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/inverse_gamma.py).
