...
<meta itemprop="name" content="tf.contrib.distributions.MultivariateNormalTriL" />
...
Defined in [`tensorflow/contrib/distributions/python/ops/mvn_tril.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/mvn_tril.py).
