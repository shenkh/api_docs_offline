...
<meta itemprop="name" content="tf.contrib.distributions.bijectors.FillTriangular" />
...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/fill_triangular.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/bijectors/fill_triangular.py).
...
Instantiates the `FillTriangular` bijector. (deprecated)
