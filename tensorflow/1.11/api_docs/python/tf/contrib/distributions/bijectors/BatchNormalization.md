...
<meta itemprop="name" content="tf.contrib.distributions.bijectors.BatchNormalization" />
...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/batch_normalization.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/bijectors/batch_normalization.py).
...
* <b>`batchnorm_layer`</b>: <a href="../../../../tf/layers/BatchNormalization.md"><code>tf.layers.BatchNormalization</code></a> layer object. If `None`,
    defaults to
...
* <b>`ValueError`</b>: If bn_layer is not an instance of
    <a href="../../../../tf/layers/BatchNormalization.md"><code>tf.layers.BatchNormalization</code></a>, or if it is specified with `renorm=True`
