...
<meta itemprop="name" content="tf.contrib.distributions.bijectors.Square" />
...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/square.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/bijectors/square.py).
...
Instantiates the `Square` bijector. (deprecated)
