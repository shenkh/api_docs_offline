...
<meta itemprop="name" content="tf.contrib.distributions.bijectors.Chain" />
...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/chain.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/bijectors/chain.py).
