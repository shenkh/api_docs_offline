...
<meta itemprop="name" content="tf.contrib.distributions.HalfNormal" />
...
Defined in [`tensorflow/contrib/distributions/python/ops/half_normal.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/half_normal.py).
