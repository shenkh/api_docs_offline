...
<meta itemprop="name" content="tf.contrib.distributions.Deterministic" />
...
Defined in [`tensorflow/contrib/distributions/python/ops/deterministic.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/deterministic.py).
...
Initialize a scalar `Deterministic` distribution. (deprecated)
