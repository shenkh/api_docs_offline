...
<meta itemprop="name" content="tf.contrib.distributions.Cauchy" />
...
Defined in [`tensorflow/contrib/distributions/python/ops/cauchy.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/cauchy.py).
...
Construct Cauchy distributions. (deprecated)
