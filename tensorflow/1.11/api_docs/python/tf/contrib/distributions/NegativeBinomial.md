...
<meta itemprop="name" content="tf.contrib.distributions.NegativeBinomial" />
...
Defined in [`tensorflow/contrib/distributions/python/ops/negative_binomial.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/negative_binomial.py).
