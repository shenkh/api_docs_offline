...
<meta itemprop="name" content="tf.contrib.distributions.ExponentialWithSoftplusRate" />
...
Inherits From: [`Exponential`](../../../tf/distributions/Exponential.md)



Defined in [`tensorflow/python/ops/distributions/exponential.py`](https://www.tensorflow.org/code/tensorflow/python/ops/distributions/exponential.py).
