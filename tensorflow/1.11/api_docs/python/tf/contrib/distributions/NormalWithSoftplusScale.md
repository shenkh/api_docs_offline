...
<meta itemprop="name" content="tf.contrib.distributions.NormalWithSoftplusScale" />
...
Inherits From: [`Normal`](../../../tf/distributions/Normal.md)



Defined in [`tensorflow/python/ops/distributions/normal.py`](https://www.tensorflow.org/code/tensorflow/python/ops/distributions/normal.py).
