...
<meta itemprop="name" content="tf.contrib.estimator.DNNLinearCombinedEstimator" />
...
Defined in [`tensorflow/contrib/estimator/python/estimator/dnn_linear_combined.py`](https://www.tensorflow.org/code/tensorflow/contrib/estimator/python/estimator/dnn_linear_combined.py).
...
* <b>`linear_sparse_combiner`</b>: A string specifying how to reduce the linear model
    ...
    details, see <a href="../../../tf/feature_column/linear_model.md"><code>tf.feature_column.linear_model</code></a>.
