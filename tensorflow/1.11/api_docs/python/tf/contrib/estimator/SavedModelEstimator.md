...
<meta itemprop="name" content="tf.contrib.estimator.SavedModelEstimator" />
...
Defined in [`tensorflow/contrib/estimator/python/estimator/saved_model_estimator.py`](https://www.tensorflow.org/code/tensorflow/contrib/estimator/python/estimator/saved_model_estimator.py).
...
Example with <a href="../../../tf/estimator/DNNClassifier.md"><code>tf.estimator.DNNClassifier</code></a>:
