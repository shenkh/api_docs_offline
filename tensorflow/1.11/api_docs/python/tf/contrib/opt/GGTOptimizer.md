...
<meta itemprop="name" content="tf.contrib.opt.GGTOptimizer" />
...
Defined in [`tensorflow/contrib/opt/python/training/ggt.py`](https://www.tensorflow.org/code/tensorflow/contrib/opt/python/training/ggt.py).
