...
<meta itemprop="name" content="tf.contrib.opt.NadamOptimizer" />
...
Defined in [`tensorflow/contrib/opt/python/training/nadam_optimizer.py`](https://www.tensorflow.org/code/tensorflow/contrib/opt/python/training/nadam_optimizer.py).
