...
Defined in [`tensorflow/contrib/distribute/python/mirrored_strategy.py`](https://www.tensorflow.org/code/tensorflow/contrib/distribute/python/mirrored_strategy.py).
