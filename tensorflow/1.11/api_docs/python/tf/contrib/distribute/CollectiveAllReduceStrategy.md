...
Defined in [`tensorflow/contrib/distribute/python/collective_all_reduce_strategy.py`](https://www.tensorflow.org/code/tensorflow/contrib/distribute/python/collective_all_reduce_strategy.py).
