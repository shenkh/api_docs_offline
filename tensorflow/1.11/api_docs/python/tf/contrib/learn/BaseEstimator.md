...
<meta itemprop="name" content="tf.contrib.learn.BaseEstimator" />
...
Inherits From: [`Evaluable`](../../../tf/contrib/learn/Evaluable.md), [`Trainable`](../../../tf/contrib/learn/Trainable.md)
