...
* Class `tf.linalg.LinearOperatorFullMatrix`



Defined in [`tensorflow/python/ops/linalg/linear_operator_full_matrix.py`](https://www.tensorflow.org/code/tensorflow/python/ops/linalg/linear_operator_full_matrix.py).
