...
* Class `tf.contrib.linalg.LinearOperatorCirculant3D`
* Class `tf.linalg.LinearOperatorCirculant3D`



Defined in [`tensorflow/python/ops/linalg/linear_operator_circulant.py`](https://www.tensorflow.org/code/tensorflow/python/ops/linalg/linear_operator_circulant.py).
