...
*  They are cropped to 24 x 24 pixels, centrally for evaluation or
   <a href="../../api_docs/python/tf/image/random_crop.md"><code>tf.random_crop</code></a> for training.
...
* Randomly distort the image with <a href="../../api_docs/python/tf/image/random_brightness.md"><code>tf.image.random_brightness</code></a>.
* Randomly distort the image with <a href="../../api_docs/python/tf/image/random_contrast.md"><code>tf.image.random_contrast</code></a>.
