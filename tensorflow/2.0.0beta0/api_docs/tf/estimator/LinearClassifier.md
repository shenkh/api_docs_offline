...
* Class `tf.estimator.LinearClassifier`
...
* <b>`optimizer`</b>: An instance of `tf.Optimizer` or
  <a href="../../tf/estimator/experimental/LinearSDCA.md"><code>tf.estimator.experimental.LinearSDCA</code></a> used to train the model. Can
...
* <b>`loss_reduction`</b>: One of <a href="../../tf/keras/losses/Reduction.md"><code>tf.losses.Reduction</code></a> except `NONE`. Describes how
