...
* Class `tf.linalg.LinearOperatorInversion`



Defined in [`python/ops/linalg/linear_operator_inversion.py`](/code/stable/tensorflow/python/ops/linalg/linear_operator_inversion.py).
