...
<meta itemprop="property" content="reflection_axis"/>
...
* Class `tf.linalg.LinearOperatorHouseholder`



Defined in [`python/ops/linalg/linear_operator_householder.py`](/code/stable/tensorflow/python/ops/linalg/linear_operator_householder.py).
...
* <b>`reflection_axis`</b>:  Shape `[B1,...,Bb, N]` `Tensor` with `b >= 0` `N >= 0`.
...
<h3 id="reflection_axis"><code>reflection_axis</code></h3>
