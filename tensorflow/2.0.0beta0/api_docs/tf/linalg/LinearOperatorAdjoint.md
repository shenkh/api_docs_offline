...
* Class `tf.linalg.LinearOperatorAdjoint`



Defined in [`python/ops/linalg/linear_operator_adjoint.py`](/code/stable/tensorflow/python/ops/linalg/linear_operator_adjoint.py).
...
* <b>`operator`</b>: `LinearOperator` object.
