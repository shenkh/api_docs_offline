...
* Class `tf.linalg.LinearOperatorScaledIdentity`



Defined in [`python/ops/linalg/linear_operator_identity.py`](/code/stable/tensorflow/python/ops/linalg/linear_operator_identity.py).
