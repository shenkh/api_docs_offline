...
* Class `tf.linalg.LinearOperatorZeros`



Defined in [`python/ops/linalg/linear_operator_zeros.py`](/code/stable/tensorflow/python/ops/linalg/linear_operator_zeros.py).
