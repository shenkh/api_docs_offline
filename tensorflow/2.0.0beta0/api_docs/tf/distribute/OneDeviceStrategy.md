...
* Class `tf.distribute.OneDeviceStrategy`



Defined in [`python/distribute/one_device_strategy.py`](/code/stable/tensorflow/python/distribute/one_device_strategy.py).
