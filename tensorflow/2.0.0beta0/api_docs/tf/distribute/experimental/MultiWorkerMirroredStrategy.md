...
* Class `tf.distribute.experimental.MultiWorkerMirroredStrategy`



Defined in [`python/distribute/collective_all_reduce_strategy.py`](/code/stable/tensorflow/python/distribute/collective_all_reduce_strategy.py).
