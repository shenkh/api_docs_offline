...
Defined in [`python/keras/api/_v1/keras/layers/__init__.py`](/code/stable/tensorflow/python/keras/api/_v1/keras/layers/__init__.py).
...
[`class BatchNormalization`](../../../../tf/compat/v1/keras/layers/BatchNormalization.md): Base class of Batch normalization layer (Ioffe and Szegedy, 2014).
