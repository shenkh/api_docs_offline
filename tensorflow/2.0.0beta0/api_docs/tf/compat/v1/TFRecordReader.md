...
Queue-based input pipelines have been replaced by <a href="../../../tf/data.md"><code>tf.data</code></a>. Use <a href="../../../tf/data/TFRecordDataset.md"><code>tf.data.TFRecordDataset</code></a>.
