...
<meta itemprop="name" content="tf.compat.v1.train.experimental.MixedPrecisionLossScaleOptimizer" />
...
Defined in [`python/training/experimental/loss_scale_optimizer.py`](/code/stable/tensorflow/python/training/experimental/loss_scale_optimizer.py).
