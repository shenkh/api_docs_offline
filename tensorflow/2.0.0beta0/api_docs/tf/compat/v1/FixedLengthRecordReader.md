...
Defined in [`python/ops/io_ops.py`](/code/stable/tensorflow/python/ops/io_ops.py).
...
Queue-based input pipelines have been replaced by <a href="../../../tf/data.md"><code>tf.data</code></a>. Use <a href="../../../tf/data/FixedLengthRecordDataset.md"><code>tf.data.FixedLengthRecordDataset</code></a>.
