...
Inherits From: [`Gamma`](../../../../tf/compat/v1/distributions/Gamma.md)



Defined in [`python/ops/distributions/exponential.py`](/code/stable/tensorflow/python/ops/distributions/exponential.py).
