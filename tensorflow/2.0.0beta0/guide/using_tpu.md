...
<a href="../api_docs/python/tf/estimator/tpu/TPUEstimator.md"><code>tf.contrib.tpu.TPUEstimator</code></a> to drive a model on TPUs.
...
The changes required to use a <a href="../api_docs/python/tf/estimator/tpu/TPUEstimator.md"><code>tf.contrib.tpu.TPUEstimator</code></a> on your local
...
<a href="../api_docs/python/tf/estimator/tpu/RunConfig.md"><code>tf.contrib.tpu.RunConfig</code></a> as the `config` argument, as shown below:
...
Then you must pass the <a href="../api_docs/python/tf/estimator/tpu/RunConfig.md"><code>tf.contrib.tpu.RunConfig</code></a> to the constructor:
...
* Set `FLAGS.tpu_name` so the <a href="../api_docs/python/tf/distribute/cluster_resolver/TPUClusterResolver.md"><code>tf.contrib.cluster_resolver.TPUClusterResolver</code></a> can find it
...
<a href="../api_docs/python/tf/tpu/CrossShardOptimizer.md"><code>tf.contrib.tpu.CrossShardOptimizer</code></a>, which uses an `allreduce` to aggregate
...
`TPUEstimators` use a <a href="../api_docs/python/tf/estimator/tpu/TPUEstimatorSpec.md"><code>tf.contrib.tpu.TPUEstimatorSpec</code></a>. There are a few
