...
use <a href="../../../api_docs/python/tf/data/Dataset.md#map"><code>tf.data.Dataset.map</code></a> and `tf.decode_csv` to parses the CSV records from
...
from a `tf.parse_single_example` op and call <a href="../../../api_docs/python/tf/io/decode_jpeg.md"><code>tf.image.decode_jpeg</code></a>,
<a href="../../../api_docs/python/tf/io/decode_png.md"><code>tf.image.decode_png</code></a>, or `tf.decode_raw`.  It is common to take the output
of `tf.decode_raw` and use <a href="../../../api_docs/python/tf/slice.md"><code>tf.slice</code></a> and <a href="../../../api_docs/python/tf/reshape.md"><code>tf.reshape</code></a> to extract pieces.
