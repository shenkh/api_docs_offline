...
Feature                                        | Python                                                      | C
:--------------------------------------------- | :---------------------------------------------------------- | :--
Run a predefined Graph                         | <a href="../../../api_docs/python/tf/graph_util/import_graph_def.md"><code>tf.import_graph_def</code></a>, `tf.Session`                         | `TF_GraphImportGraphDef`, `TF_NewSession`
...
Neural Network library                         | <a href="../../../api_docs/python/tf/train.md"><code>tf.train</code></a>, <a href="../../../api_docs/python/tf/nn.md"><code>tf.nn</code></a>, `tf.contrib.layers`, `tf.contrib.slim` |
