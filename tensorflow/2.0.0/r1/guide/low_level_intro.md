...
runs TensorFlow operations. If a <a href="../../api_docs/python/tf/Graph.md"><code>tf.Graph</code></a> is like a `.py` file, a `tf.Session`
...
During a call to `tf.Session.run` any <a href="../../api_docs/python/tf/Tensor.md"><code>tf.Tensor</code></a> only has a single value.
