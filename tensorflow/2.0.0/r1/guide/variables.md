...
high-level frameworks such as `tf.contrib.slim`, <a href="../../api_docs/python/tf/estimator/Estimator.md"><code>tf.estimator.Estimator</code></a> and
 ...
 * Implicitly wrapping <a href="../../api_docs/python/tf/Variable.md"><code>tf.Variable</code></a> objects within `tf.variable_scope` objects.
...
`tf.layers` use this approach, as well as all <a href="../../api_docs/python/tf/metrics.md"><code>tf.metrics</code></a>, and a few other
library utilities.
