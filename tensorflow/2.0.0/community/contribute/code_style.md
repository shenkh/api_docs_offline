...
*   When possible, use a Tensor's overloaded operators rather than TensorFlow
    ...
    <a href="../../api_docs/python/tf/math/pow.md"><code>tf.pow</code></a>, <a href="../../api_docs/python/tf/math/add.md"><code>tf.add</code></a>, <a href="../../api_docs/python/tf/math/divide.md"><code>tf.divide</code></a>, <a href="../../api_docs/python/tf/math/multiply.md"><code>tf.multiply</code></a>, <a href="../../api_docs/python/tf/math/subtract.md"><code>tf.subtract</code></a>, and `tf.logical_*` —
...
*   Avoid making explicit use of <a href="../../api_docs/python/tf/Tensor.md#eval"><code>tf.Tensor.eval</code></a> or `tf.Session.run`. For
