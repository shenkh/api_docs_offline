...
Defined in [`tensorflow/python/keras/mixed_precision/experimental/loss_scale_optimizer.py`](/code/stable/tensorflow/python/keras/mixed_precision/experimental/loss_scale_optimizer.py).
