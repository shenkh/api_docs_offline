...
Defined in [`tensorflow/python/keras/premade/wide_deep.py`](/code/stable/tensorflow/python/keras/premade/wide_deep.py).
...
# or define a single <a href="../../../tf/data/Dataset.md"><code>tf.data.Dataset</code></a> that contains a single tensor or
...
* <b>`linear_model`</b>: a premade LinearModel, its output must match the output of
    the dnn model.
* <b>`dnn_model`</b>: a <a href="../../../tf/keras/Model.md"><code>tf.keras.Model</code></a>, its output must match the output of the
    linear model.
