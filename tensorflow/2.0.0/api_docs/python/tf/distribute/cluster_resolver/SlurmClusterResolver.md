...
Defined in [`tensorflow/python/distribute/cluster_resolver/slurm_cluster_resolver.py`](/code/stable/tensorflow/python/distribute/cluster_resolver/slurm_cluster_resolver.py).
