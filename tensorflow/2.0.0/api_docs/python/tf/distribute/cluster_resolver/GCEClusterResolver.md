...
Defined in [`tensorflow/python/distribute/cluster_resolver/gce_cluster_resolver.py`](/code/stable/tensorflow/python/distribute/cluster_resolver/gce_cluster_resolver.py).
