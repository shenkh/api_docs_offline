...
Defined in [`tensorflow/python/ops/linalg/linear_operator_low_rank_update.py`](/code/stable/tensorflow/python/ops/linalg/linear_operator_low_rank_update.py).
