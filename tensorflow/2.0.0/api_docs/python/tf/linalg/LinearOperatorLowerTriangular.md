...
Defined in [`tensorflow/python/ops/linalg/linear_operator_lower_triangular.py`](/code/stable/tensorflow/python/ops/linalg/linear_operator_lower_triangular.py).
