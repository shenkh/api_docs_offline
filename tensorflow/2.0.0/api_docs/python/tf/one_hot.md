...
value <a href="../tf/dtypes.md#float32"><code>tf.float32</code></a>.

Note: If a non-numeric data type output is desired (<a href="../tf/dtypes.md#string"><code>tf.string</code></a>, <a href="../tf/dtypes.md#bool"><code>tf.bool</code></a>,
