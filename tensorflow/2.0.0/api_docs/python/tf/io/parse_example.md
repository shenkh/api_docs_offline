...
<a href="../../tf/dtypes.md#float32"><code>tf.float32</code></a> if not specified) and shape `(serialized.size(),) + df.shape`.
...
(or <a href="../../tf/dtypes.md#float32"><code>tf.float32</code></a> if not specified) and shape
...
For example, if one expects a <a href="../../tf/dtypes.md#float32"><code>tf.float32</code></a> `VarLenFeature` `ft` and three
