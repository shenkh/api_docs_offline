...
<meta itemprop="name" content="tf.optimizers.Adagrad" />
...
Defined in [`tensorflow/python/keras/optimizer_v2/adagrad.py`](/code/stable/tensorflow/python/keras/optimizer_v2/adagrad.py).
