...
<meta itemprop="name" content="tf.optimizers.SGD" />
...
Defined in [`tensorflow/python/keras/optimizer_v2/gradient_descent.py`](/code/stable/tensorflow/python/keras/optimizer_v2/gradient_descent.py).
