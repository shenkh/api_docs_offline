...
<meta itemprop="name" content="tf.optimizers.Optimizer" />
...
Defined in [`tensorflow/python/keras/optimizer_v2/optimizer_v2.py`](/code/stable/tensorflow/python/keras/optimizer_v2/optimizer_v2.py).

Updated base class for optimizers.

This class defines the API to add Ops to train a model.  You never use this
class directly, but instead instantiate one of its subclasses such as
<a href="../../tf/optimizers/SGD.md"><code>tf.keras.optimizers.SGD</code></a>, <a href="../../tf/optimizers/Adam.md"><code>tf.keras.optimizers.Adam</code></a>.
