...
<meta itemprop="name" content="tf.optimizers.RMSprop" />
...
Defined in [`tensorflow/python/keras/optimizer_v2/rmsprop.py`](/code/stable/tensorflow/python/keras/optimizer_v2/rmsprop.py).
