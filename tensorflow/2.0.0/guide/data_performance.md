...
<a href="../api_docs/python/tf/data/Dataset.md"><code>tf.data.Dataset</code></a> which can passed to high-level TensorFlow API such as
<a href="../api_docs/python/tf/keras.md"><code>tf.keras</code></a>.
...
this value, or set it to <a href="../api_docs/python/tf/data/experimental.md#AUTOTUNE"><code>tf.data.experimental.AUTOTUNE</code></a> which will prompt the
...
<a href="../api_docs/python/tf/data/experimental.md#AUTOTUNE"><code>tf.data.experimental.AUTOTUNE</code></a> which will delegate the decision about what
...
<a href="../api_docs/python/tf/data/Dataset.md#interleave"><code>tf.data.Dataset.interleave</code></a> transformation can be used to parallelize the data
...
The <a href="../api_docs/python/tf/data/Dataset.md#cache"><code>tf.data.Dataset.cache</code></a> transformation can cache a dataset, either in memory
...
as an _epoch_. The <a href="../api_docs/python/tf/data/Dataset.md#shuffle"><code>tf.data.Dataset.shuffle</code></a> transformation randomizes the order
...
*   Use the `prefetch` transformation to overlap the work of a producer and
    ...
    using <a href="../api_docs/python/tf/data/experimental.md#AUTOTUNE"><code>tf.data.experimental.AUTOTUNE</code></a> to delegate the decision to the
    tf.data runtime.
*   Parallelize the `map` transformation by setting the `num_parallel_calls`
    ...
    <a href="../api_docs/python/tf/data/experimental.md#AUTOTUNE"><code>tf.data.experimental.AUTOTUNE</code></a> to delegate the decision to the tf.data
    runtime.
